...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->code_length   = 4;
		$this->charset       = 'ABCDEFGHKLMNPRSTUVWYZ23456789'; //(abcdefghklmnprstuvwyz)->bo sung neu can phan biet chu hoa - thuong
		$this->wordlist_file = './words/words.txt';
		$this->use_wordlist  = false;

		$this->gd_font_file  = 'gdfonts/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 10;
		$this->text_x_start  = 10;

		$this->ttf_file      = './AHGBold.ttf'; // font chu

		$this->perturbation       = 0; // do cong cua chu
		$this->iscale             = 5;
		...
		$this->num_lines            = 0; // so duong vach tren nen anh lam tang do phuc tap
