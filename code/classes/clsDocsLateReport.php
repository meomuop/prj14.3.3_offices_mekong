...
class docslatereport_class extends dbBasic {
  	var  $doc_id;
	var  $docCat_id;
	var  $docField_id;
	var  $docLevel_id;
	...
	var  $DR_doc_id;
	var  $DR_user_id;
	var  $DR_department_id;
	var  $DR_main_department;
	var  $process_per;
	var  $docReply_active;
	var  $docReply_traned;
	var  $process_level;
	...
	var $pfields = array (	'doc_id',
							...
							'coordinate_per',
							'docReply_numday',
							'docReply_limit_time'); //table private fields
							
  	var $pkeys = array ('doc_id'); //key fields
  
 	function docslatereport_class(){ 
    	$this->dbBasic();  
    	$this->tablename = "doc_latereport";
  	}
