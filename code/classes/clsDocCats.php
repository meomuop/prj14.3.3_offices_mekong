...
class docCat_class extends dbBasic {
	...
	// --- getTypical
    function getTypical($id){
        global $dbconn;
        // ---- Get sql query
        $sql = " SELECT docCat_typical FROM $this->tablename where docCat_id=".$id;
        // ---- Execute SQL
        $result = $dbconn->Execute($sql);
		return $result->fields[0];
    }
	...
	// --- changeTypical
    function changeTypical($id){
        global $dbconn;
        // ---- Get sql query
        $sql = " UPDATE $this->tablename set docCat_typical=1 where docCat_id=".$id;
        // ---- Execute SQL
        $result = $dbconn->Execute($sql);
		return $result->fields[0];
    }
