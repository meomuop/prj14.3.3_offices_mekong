...
CREATE TABLE `tbl_hd_khachhang` (
  ...
  `khachhang_active` bit(1) DEFAULT NULL,
...
CREATE TABLE `tbl_hdmua_danhmuc` (
  ...
  `danhmuc_sort` int(11) DEFAULT NULL,
  `danhmuc_active` bit(1) DEFAULT NULL,
...
CREATE TABLE `tbl_hdmua_hanghoa` (
  ...
  `hanghoa_sort` int(11) DEFAULT NULL,
  `hanghoa_active` bit(1) DEFAULT NULL,
