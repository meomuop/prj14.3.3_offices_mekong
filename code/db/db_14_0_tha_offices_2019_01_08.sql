...
insert  into `tbl_config`(`config_id`,`owner_name`,`owner_add`,`owner_phone`,`owner_fax`,`owner_email`,`owner_reemail`,`owner_url`,`luong_coban`,`luong_apdung`,`ngay_macdinh`,`sat_ra`,`sun_ra`,`site_port`,`site_active`,`site_inactive_info`) values (1,'Tập đoàn MEKONG','Trụ sở: Tầng 5, tòa nhà 21 T2, dự án Hapulico Complex, số 1 Nguyễn Huy Tưởng , Thanh Xuân Trung, Thanh Xuân, Hà Nội','(84-4)35584167','(84-4)35584167','info@mekonggroup.net',NULL,'MEKONG GROUP',2000000,1,'2018-12-31',2,2,'COM5',NULL,NULL);
...
insert  into `tbl_cv_cats`(`cv_cat_id`,`cv_cat_name`,`cv_cat_desc`,`cv_cat_priority`,`cv_cat_date`,`cv_cat_sort`,`cv_cat_active`,`user_id`) values (1,'Thử nghiệm 1','Thử nghiệm 1',0,'2016-02-19',0,1,31),(2,'Triển khai phần mềm quản lý văn phòng điện tử','Triển khai phần mềm quản lý văn phòng điện tử trong đầu năm 2019',0,'2018-12-17',0,1,31);
...
insert  into `tbl_cv_indexs`(`cv_index_id`,`cv_sub_id`,`process_user`,`cv_index_name`,`cv_index_desc`,`cv_index_date`,`cv_index_sort`,`cv_index_active`,`user_id`) values (1,5,48,NULL,NULL,'2018-12-17',0,0,42),(2,3,55,NULL,NULL,'2018-12-17',0,0,41),(3,5,51,NULL,NULL,'2018-12-17',0,0,42),(4,5,52,NULL,NULL,'2018-12-17',0,0,42);
...
insert  into `tbl_cv_logs`(`cv_log_id`,`cv_index_id`,`cv_log_num_day`,`cv_log_desc`,`cv_log_note`,`cv_log_date`,`cv_log_sort`,`cv_log_active`,`user_id`) values (1,1,NULL,'Triển khai phần chức năng công viêc','Xử lý các công việc được giao',NULL,0,0,42),(2,1,NULL,'Triển khai phần chức năng Lịch làm việc cá nhân','Đặt lịch làm việc trong 1 tuần',NULL,0,0,42);
...
insert  into `tbl_cv_subs`(`cv_sub_id`,`cv_cat_id`,`department_id`,`cv_sub_name`,`cv_sub_desc`,`cv_sub_time_limit`,`cv_sub_date`,`cv_sub_sort`,`cv_sub_active`,`user_id`) values (1,1,16,'Nhánh việc 1','undefined','2016-02-24','2016-02-24',0,0,31),(2,1,17,'Nhánh việc 1','undefined','2016-02-24','2016-02-24',0,0,31),(3,2,13,'Triển khai giai đoạn 1','Các phòng ban trực thuộc','2018-12-28','2018-12-17',0,0,31),(4,2,14,'Triển khai giai đoạn 1','Các phòng ban trực thuộc','2018-12-28','2018-12-17',0,0,31),(5,2,15,'Triển khai giai đoạn 1','Các phòng ban trực thuộc','2018-12-28','2018-12-17',0,0,31),(6,2,16,'Triển khai giai đoạn 1','Các phòng ban trực thuộc','2018-12-28','2018-12-17',0,0,31),(7,2,17,'Triển khai giai đoạn 1','Các phòng ban trực thuộc','2018-12-28','2018-12-17',0,0,31),(8,2,18,'Triển khai giai đoạn 1','Các phòng ban trực thuộc','2018-12-28','2018-12-17',0,0,31);
...
insert  into `tbl_docfiles`(`docFile_id`,`doc_id`,`docFile_name`,`docFile_path`,`docFile_date`,`docFile_sort`,`docFile_active`,`user_id`) values (1,46,'02/CV-CC2','../doc_uploads_2016/62f948e10ab6dc5f7e1e5de3533d3ce0.jpg','2016-02-17 00:00:00',NULL,NULL,49),(2,46,'01/CV-KHKT','../doc_uploads_2016/00e7f67e3bcb8751f03147361532da70.jpg','2016-02-17 00:00:00',NULL,NULL,49),(3,45,'01/CV-THP','../doc_uploads_2018/291164692bc40ccb99eb366e48a54bec.png','2018-12-26 00:00:00',NULL,NULL,1);
...
insert  into `tbl_docoutfiles`(`docOutFile_id`,`docOut_id`,`docOutFile_name`,`docOutFile_path`,`docOutFile_date`,`docOutFile_sort`,`docOutFile_active`,`user_id`) values (1,1,'1/CV-Hacinco','../doc_uploads_2018/d9c0132684aa750f8b9d2cb87f9327f2.jpg','2018-12-27 00:00:00',0,0,0);
...
insert  into `tbl_docs`(`doc_id`,`docCat_id`,`docField_id`,`docLevel_id`,`unit_name`,`doc_code`,`doc_num`,`doc_desc`,`doc_note`,`doc_note_code`,`doc_note_sign_date`,`doc_note_sign_per`,`doc_note_date`,`doc_recevied`,`doc_limit_time`,`doc_signed`,`doc_moved`,`signPer_id`,`signObj_id`,`secret_id`,`important_id`,`doc_date`,`doc_sort`,`doc_traned`,`doc_replied`,`doc_active`,`doc_file`,`user_id`,`input_per`,`doc_theodoi`) values (45,'Công văn','Xây dựng',2,'Công ty Cổ phần Thép Hòa Phát','01/CV-THP',5,'V/v thông báo chuyển lô hàng đầu tiên 500 cây thép D12.',NULL,NULL,NULL,NULL,NULL,'2018-12-24','1970-01-01','2018-12-22','1970-01-01','Nguyễn Văn Hải','Giám đốc',1,1,'2016-02-15',NULL,2,2,2,1,'0',1,0),(46,'Công văn','Xây dựng',2,'Phòng công chứng NN số 2','02/CV-CC2',2,'Văn bản thử nghiệm số 2','Giao Đ/c Nguyễn Bá Vân chỉ đạo.','02/CV-KHKT','2016-02-17','Trưởng phòng KHKT','2016-02-17','2016-02-15','1970-01-01','2016-02-15','2016-02-16','Ngọ Duy Hiểu','Giám đốc',1,1,'2016-02-15',NULL,1,1,4,1,'31',40,1),(47,'Công văn','Xây dựng',1,'Công ty QL và PT nhà HN','03/CV-QLPTNHN',1,'Văn bản thử nghiệm số 3','Giao Phòng Kế hoạch kỹ thuật giải quyết, ban Trợ lý phối hợp.',NULL,NULL,NULL,NULL,'2016-02-15','1970-01-01','2016-02-15','2016-02-16','Nguyễn Hữu Độ','Giám đốc',1,1,'2016-02-15',NULL,1,1,2,2,'31',40,0),(48,'Công văn','Xây dựng',2,'Phòng công chứng NN số 3','04/CV-CC3',3,'Văn bản thử nghiệm số 4','Giao ban trợ lý giải quyết',NULL,NULL,NULL,NULL,'2016-02-15','1970-01-01','2016-02-15','2016-02-16','Phạm Văn Khương','Phó giám đốc',1,1,'2016-02-15',NULL,1,1,2,2,'31',40,1),(49,'Công văn','Xây dựng',2,'Phòng công chứng NN số 4','05/CV-CC4',4,'Văn bản thử nghiệm số 5','Gửi phòng Kế hoạch kỹ thuật lên phương án giải quyết',NULL,NULL,NULL,NULL,'2016-02-15','1970-01-01','2016-02-15','2016-02-16','Vũ Hồng Khanh','Giám đốc',1,1,'2016-02-15',NULL,1,2,2,2,'31',40,0);
...
/*Table structure for table `tbl_hd_doitac` */
...
CREATE TABLE `tbl_hd_duan` (
  ...
  `duan_name` varchar(250) NOT NULL,
  `duan_thuongmai` varchar(250) DEFAULT NULL,
  `duan_maduan` varchar(150) DEFAULT NULL,
  `duan_chudautu` varchar(250) DEFAULT NULL,
...
insert  into `tbl_hd_duan`(`duan_id`,`duan_name`,`duan_thuongmai`,`duan_maduan`,`duan_chudautu`,`duan_mota`,`duan_sort`,`duan_active`,`duan_date`) values (2,'Trụ sở công ty, trung tâm thương mại, văn phòng và căn hộ cho thuê','Dự án 125 Hoàng Ngân','125-HN','Công ty cổ phần Hà Thăng – Công ty CP Xây dựng và phát triển đô thị Mê Kông (Mekong Invest)','Vị trí dự án: Số 125 Phố Hoàng Ngân, p. Trung Hòa, q. Thanh Xuân, tp. Hà Nội\nThời gian thực hiện: Từ Qúy III/2014 đến Quý III/2016\nTổng mức đầu tư: 275 tỷ đồng',NULL,1,'2019-01-04');
...
/*Table structure for table `tbl_hd_dvtinh` */

DROP TABLE IF EXISTS `tbl_hd_dvtinh`;
...
/*Data for the table `tbl_hd_dvtinh` */

insert  into `tbl_hd_dvtinh`(`dvtinh_id`,`dvtinh_name`,`dvtinh_sort`,`dvtinh_active`,`dvtinh_date`) values (1,'Cái',0,1,'2018-12-21'),(2,'Cây',0,1,'2018-12-21'),(3,'Cuộn',0,1,'2018-12-21'),(4,'Tấm',0,1,'2018-12-21'),(5,'Bao',0,1,'2018-12-21'),(6,'Viên',0,1,'2018-12-21'),(7,'Tấn',0,1,'2018-12-21'),(8,'Tạ',0,1,'2018-12-21'),(9,'Chiếc',0,1,'2018-12-21'),(10,'Bộ',0,1,'2018-12-21'),(11,'Thùng',0,1,'2018-12-21'),(12,'Mét',0,1,'2018-12-24');
...
CREATE TABLE `tbl_hd_hdban` (
  ...
  `hdban_ngayhd` date DEFAULT NULL,
  `hdban_hieuluc` date DEFAULT NULL,
  `hdban_noidung` text,
  `hdban_tgth` int(11) DEFAULT NULL COMMENT 'thoi gian thuc hien',
  `hdban_kieu_tgth` int(11) DEFAULT NULL COMMENT '1. ngay, 2. thang, 3. nam',
  `dvtiente_id` int(11) DEFAULT NULL,
  `hdban_giatri` double DEFAULT NULL,
  `hdban_giatri_quydoi` bigint(20) DEFAULT NULL,
  `hdban_gttt` double DEFAULT NULL,
  `hdban_gttt_quydoi` bigint(20) DEFAULT NULL,
  `khachhang_id` int(11) DEFAULT NULL,
  `khachhang_viettat` varchar(150) DEFAULT NULL,
  ...
  `hdban_tinhtrang` tinyint(4) DEFAULT NULL COMMENT '1. moi, 2. dang thuc hien, 3. da xong, 4. da huy',
  `hdban_tl_huybo` bigint(20) DEFAULT NULL,
  `hdban_lydo_huybo` varchar(250) DEFAULT NULL,
  `hdban_dieukhoankhac` text,
  `hdban_file` tinyint(4) DEFAULT '2' COMMENT '1. da dinh tep tin, 2. chua dinh tep tin',
  `hdban_nguoinhap` int(11) DEFAULT NULL,
  `hdban_date` date DEFAULT NULL,
  PRIMARY KEY (`hdban_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `tbl_hd_hdban` */

insert  into `tbl_hd_hdban`(`hdban_id`,`hdban_sohd`,`hdban_ngayhd`,`hdban_hieuluc`,`hdban_noidung`,`hdban_tgth`,`hdban_kieu_tgth`,`dvtiente_id`,`hdban_giatri`,`hdban_giatri_quydoi`,`hdban_gttt`,`hdban_gttt_quydoi`,`khachhang_id`,`khachhang_viettat`,`department_id`,`phongban_name`,`user_id`,`nguoi_theodoi`,`hdban_tinhtrang`,`hdban_tl_huybo`,`hdban_lydo_huybo`,`hdban_dieukhoankhac`,`hdban_file`,`hdban_nguoinhap`,`hdban_date`) values (1,'01/MK-HDKT','2019-01-03','2019-01-23','Thi công dự án 125 Hoàng Ngân',12,2,1,285000000000,285000000000,285000000000,285000000000,2,'KHS-2',26,'Ban Quản lý dự án 1',44,'Trưởng ban QLDA1',2,NULL,NULL,'Hợp đồng có thể gia hạn trong trường hợp có thay đổi thực tế.',2,1,'2019-01-05');

/*Table structure for table `tbl_hd_hdban_chiphi` */
...
/*Data for the table `tbl_hd_hdban_chiphi` */

/*Table structure for table `tbl_hd_hdban_dt` */

DROP TABLE IF EXISTS `tbl_hd_hdban_dt`;

CREATE TABLE `tbl_hd_hdban_dt` (
  `dthdban_id` int(11) NOT NULL AUTO_INCREMENT,
  `dthdban_sohd` varchar(100) DEFAULT NULL,
  `dthdban_hieuluc` int(11) DEFAULT NULL COMMENT 'so ngay hieu luc',
  `dthdban_noidung` text,
  `dthdban_tgth` int(11) DEFAULT NULL COMMENT 'thoi gian thuc hien',
  `dthdban_kieu_tgth` int(11) DEFAULT NULL COMMENT '1. ngay, 2. thang, 3. nam',
  `dvtiente_id` int(11) DEFAULT NULL,
  `dthdban_giatri` double DEFAULT NULL,
  `dthdban_giatri_quydoi` bigint(20) DEFAULT NULL,
  `dthdban_gttt` double DEFAULT NULL,
  `dthdban_gttt_quydoi` bigint(20) DEFAULT NULL,
  `khachhang_id` int(11) DEFAULT NULL,
  `khachhang_viettat` varchar(150) DEFAULT NULL,
  `department_id` int(11) DEFAULT NULL COMMENT 'phong du thao',
  `user_id` int(11) DEFAULT NULL COMMENT 'nguoi du thao',
  `dthdban_tinhtrang` tinyint(4) DEFAULT NULL COMMENT '1. moi du thao, 2. duyet phong, 3. duyet cty, 4. da ky ket, 5. da huy bo',
  `dthdban_dieukhoankhac` text,
  `dthdban_file` tinyint(4) DEFAULT '2' COMMENT '1. da dinh tep tin, 2. chua dinh tep tin',
  `dthdban_date` date DEFAULT NULL,
  PRIMARY KEY (`dthdban_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `tbl_hd_hdban_dt` */

insert  into `tbl_hd_hdban_dt`(`dthdban_id`,`dthdban_sohd`,`dthdban_hieuluc`,`dthdban_noidung`,`dthdban_tgth`,`dthdban_kieu_tgth`,`dvtiente_id`,`dthdban_giatri`,`dthdban_giatri_quydoi`,`dthdban_gttt`,`dthdban_gttt_quydoi`,`khachhang_id`,`khachhang_viettat`,`department_id`,`user_id`,`dthdban_tinhtrang`,`dthdban_dieukhoankhac`,`dthdban_file`,`dthdban_date`) values (1,'02/MK-DT',60,'Thi công bãi đỗ xe cho khu vui chơi Dislay Land 2, Hà Nội',2,2,1,12000000000,12000000000,12000000000,12000000000,1,'THANH XUAN DEVELOPMENT.,JSC',15,1,1,'Không có',2,'2019-01-07');

/*Table structure for table `tbl_hd_hdban_dt_file` */

DROP TABLE IF EXISTS `tbl_hd_hdban_dt_file`;

CREATE TABLE `tbl_hd_hdban_dt_file` (
  `hdfile_id` int(11) NOT NULL AUTO_INCREMENT,
  `dthdban_id` int(11) DEFAULT NULL,
  `dthdban_sohd` varchar(250) DEFAULT NULL,
  `hdfile_name` varchar(250) DEFAULT NULL,
  `hdfile_path` varchar(250) DEFAULT NULL,
  `hdfile_phanhoi` varchar(250) DEFAULT NULL,
  `hdfile_ykien` varchar(250) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `hdfile_date` date DEFAULT NULL,
  `hdfile_status` tinyint(4) DEFAULT NULL COMMENT '1. trinh, 2. duyet, 3. phan hoi',
  PRIMARY KEY (`hdfile_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Data for the table `tbl_hd_hdban_dt_file` */

insert  into `tbl_hd_hdban_dt_file`(`hdfile_id`,`dthdban_id`,`dthdban_sohd`,`hdfile_name`,`hdfile_path`,`hdfile_phanhoi`,`hdfile_ykien`,`user_id`,`hdfile_date`,`hdfile_status`) values (1,0,'../hdmua_tientrinh_uploads_2018/463bfcd287b2e1585dcefb1cb9c55190.jpg','1','01/HĐKT-THP',NULL,NULL,1,'2018-12-26',NULL),(3,3,'03/HĐKT-XT','03/HĐKT-XT','../hopdong_uploads_2019/hdmua/463bfcd287b2e1585dcefb1cb9c55190.jpg',NULL,NULL,1,'2019-01-08',NULL);

/*Table structure for table `tbl_hd_hdban_file` */

DROP TABLE IF EXISTS `tbl_hd_hdban_file`;

CREATE TABLE `tbl_hd_hdban_file` (
  `hdfile_id` int(11) NOT NULL AUTO_INCREMENT,
  `hdban_id` int(11) DEFAULT NULL,
  `hdban_sohd` varchar(250) DEFAULT NULL,
  `hdfile_name` varchar(250) DEFAULT NULL,
  `hdfile_path` varchar(250) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `hdfile_date` date DEFAULT NULL,
...
/*Data for the table `tbl_hd_hdban_file` */

insert  into `tbl_hd_hdban_file`(`hdfile_id`,`hdban_id`,`hdban_sohd`,`hdfile_name`,`hdfile_path`,`user_id`,`hdfile_date`,`hdfile_active`) values (1,0,'../hdmua_tientrinh_uploads_2018/463bfcd287b2e1585dcefb1cb9c55190.jpg','1','01/HĐKT-THP',1,'2018-12-26',NULL),(3,3,'03/HĐKT-XT','03/HĐKT-XT','../hopdong_uploads_2019/hdmua/463bfcd287b2e1585dcefb1cb9c55190.jpg',1,'2019-01-08',NULL);

/*Table structure for table `tbl_hd_hdban_hoadon` */
...
insert  into `tbl_hd_hdban_lkvb`(`lkvb_id`,`hdban_id`,`hdban_sohd`,`vanban_id`,`vanban_skh`,`vanban_trichyeu`,`vanban_file`,`lkvb_type`,`user_id`,`lkvb_date`,`lkvb_active`) values (1,1,'01/MK-HDKT',NULL,'01/CV-THP','V/v thông báo chuyển lô hàng đầu tiên 500 cây thép D12.','../doc_uploads_2018/291164692bc40ccb99eb366e48a54bec.png',1,1,'2019-01-05',NULL);
...
insert  into `tbl_hd_hdban_tientrinh`(`tientrinh_id`,`tientrinh_ghichu`,`tientrinh_file`,`hdban_id`,`hdban_sohd`,`user_id`,`tientrinh_date`,`tientrinh_active`) values (1,'Đã chuyển tiền hoa hồng đợt 1 vào ngày 05/01/2019','../hdban_tientrinh_uploads_2019/ef56a3cd41c2b0d47de92561b210be9b.jpg',1,'01/MK-HDKT',1,'2019-01-05',NULL);
...
/*Data for the table `tbl_hd_hdban_xuatkho` */

insert  into `tbl_hd_hdban_xuatkho`(`xuatkho_id`,`hoadon_id`,`hoadon_sohd`,`dvtinh_id`,`dvtinh_name`,`hanghoa_id`,`hanghoa_name`,`xuatkho_soluong`,`xuatkho_nguoinhap`,`xuatkho_date`) values (1,1,'18/MK-PC',2,'Cây',2,'Thép phi 12',100,1,'2019-01-07');

/*Table structure for table `tbl_hd_hdmua` */
...
CREATE TABLE `tbl_hd_hdmua_file` (
  `hdfile_id` int(11) NOT NULL AUTO_INCREMENT,
  `hdmua_id` int(11) DEFAULT NULL,
  `hdmua_sohd` varchar(250) DEFAULT NULL,
  `hdfile_name` varchar(250) DEFAULT NULL,
  `hdfile_path` varchar(250) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `hdfile_date` date DEFAULT NULL,
...
insert  into `tbl_hd_hdmua_file`(`hdfile_id`,`hdmua_id`,`hdmua_sohd`,`hdfile_name`,`hdfile_path`,`user_id`,`hdfile_date`,`hdfile_active`) values (1,0,'../hdmua_tientrinh_uploads_2018/463bfcd287b2e1585dcefb1cb9c55190.jpg','1','01/HĐKT-THP',1,'2018-12-26',NULL),(3,3,'03/HĐKT-XT','03/HĐKT-XT','../hopdong_uploads_2019/hdmua/463bfcd287b2e1585dcefb1cb9c55190.jpg',1,'2019-01-08',NULL);
...
/*Data for the table `tbl_hd_hdmua_tientrinh` */

insert  into `tbl_hd_hdmua_tientrinh`(`tientrinh_id`,`tientrinh_ghichu`,`tientrinh_file`,`hdmua_id`,`hdmua_sohd`,`user_id`,`tientrinh_date`,`tientrinh_active`) values (1,'Đã chuyển lô hang đầu tiên gồm 500 cây thép D12','../hdmua_tientrinh_uploads_2018/463bfcd287b2e1585dcefb1cb9c55190.jpg',1,'01/HĐKT-THP',1,'2018-12-26',NULL);

/*Table structure for table `tbl_hd_hdmua_tonkho` */
...
CREATE TABLE `tbl_hd_khachhang` (
  ...
  `khachhang_name` varchar(250) DEFAULT NULL,
  `khachhang_viettat` varchar(150) DEFAULT NULL,
  `khachhang_daidien` varchar(150) DEFAULT NULL,
  `khachhang_mst` varchar(100) DEFAULT NULL,
  `khachhang_truso` varchar(250) DEFAULT NULL,
  `khachhang_vpgd` varchar(250) DEFAULT NULL,
  `khachhang_sdt` varchar(100) DEFAULT NULL,
  `khachhang_fax` varchar(100) DEFAULT NULL,
  `khachhang_email` varchar(250) DEFAULT NULL,
  `khachhang_sort` int(11) DEFAULT '0',
  `khachhang_active` tinyint(1) DEFAULT NULL,
...
insert  into `tbl_hd_khachhang`(`khachhang_id`,`khachhang_name`,`khachhang_viettat`,`khachhang_daidien`,`khachhang_mst`,`khachhang_truso`,`khachhang_vpgd`,`khachhang_sdt`,`khachhang_fax`,`khachhang_email`,`khachhang_sort`,`khachhang_active`,`khachhang_date`) values (1,'Công ty cổ phần đâu tư phát triển Thanh Xuân','THANH XUAN DEVELOPMENT.,JSC','Phạm Đình Việt','0100962064','Số 6, phố Lê Văn Thiêm, Phường Thanh Xuân Trung, Quận Thanh Xuân, Thành phố Hà Nội','Số 6, phố Lê Văn Thiêm, Phường Thanh Xuân Trung, Quận Thanh Xuân, Thành phố Hà Nội','0435586530','0435586530','info@thanhxuandevelopment.com',NULL,1,'2019-01-04'),(2,'Công ty CP Xây dựng Khách hàng số 2','KHS-2','Nguyễn Văn B','112345678','Trụ sở khách hàng số 2','Văn phòng khách hàng số 2','042 666 8888','042 666 8888','info@khachhangso2.com',0,1,'2019-01-04');
...
/*Data for the table `tbl_hdmua_danhmuc` */

insert  into `tbl_hdmua_danhmuc`(`danhmuc_id`,`danhmuc_name`,`danhmuc_viettat`,`danhmuc_mota`,`danhmuc_sort`,`danhmuc_active`,`danhmuc_date`) values (1,'Vật liệu xây dựng','VLXD','Vật liệu, hàng hóa phục vụ thi công công trình xây dựng',0,1,'2018-12-18'),(2,'Sản phẩm nội, ngoại thất','NNT','Các sản phẩm thi công nội, ngoại thất',0,1,'2018-12-18'),(3,'Hệ thống điện','HTĐ','Các sản phẩm thi điện lắp đặt trong công trình',0,1,'2018-12-18'),(4,'Hệ thống nước','HTN','Các sản phẩm thi công, lắp đặt hệ thống nước trong công trình',0,1,'2018-12-18'),(5,'Hệ thống phòng chống cháy nổ','PCCN','Hàng hóa thi công lắp đặt hệ thống phòng chống cháy nổ cho công trình',0,1,'2018-12-18'),(6,'Hệ thống giám sát','HTGS','Các sản phẩm thi công lắp đặt trong hệ thống giám sát của công trình',0,1,'2018-12-18');

/*Table structure for table `tbl_hdmua_hanghoa` */

DROP TABLE IF EXISTS `tbl_hdmua_hanghoa`;
...
insert  into `tbl_hdmua_hanghoa`(`hanghoa_id`,`danhmuc_id`,`hanghoa_name`,`hanghoa_mahang`,`hanghoa_mota`,`hanghoa_sort`,`hanghoa_active`,`hanghoa_date`) values (1,1,'Tấm bê tông đúc sẵn 3x3 m','BTĐS 3x3','Tấm bê tông đúc sẵn 3x3 m',NULL,1,'2018-12-18'),(2,1,'Thép phi 12','T-D12','Thép phi 12',NULL,1,'2018-12-18'),(3,1,'Thép phi 15','T-D15','Thép phi 15',0,1,'2018-12-19'),(4,1,'Thép cuộn phi 10','TC-D10','Thép cuộn phi 10 để đan bê tông',0,1,'2018-12-24');
...
/*Table structure for table `tbl_luong_chamcong` */

DROP TABLE IF EXISTS `tbl_luong_chamcong`;
...
/*Data for the table `tbl_luong_phucap` */

insert  into `tbl_luong_phucap`(`phucap_id`,`phucap_ten`,`phucap_giatri`,`phucap_diengiai`,`phucap_date`,`phucap_sort`,`phucap_active`) values (1,'Hỗ trợ nhân viên',1000000,'600.000 hỗ trợ ăn trưa, 200.000 hỗ trợ đi lại, 200.000 hỗ trợ liên lạc.','2018-12-30',0,1),(2,'Hồ trợ cấp phó phòng/ban',1400000,'600.000 hỗ trợ tiền ăn, 400.000 hỗ trợ đi lại, 400.000 hỗ trợ liên lạc.','2018-12-30',NULL,1),(3,'Hỗ trợ cấp trưởng phòng/ban',1800000,'600.000 hồ trợ tiền ăn, 600.000 hỗ trợ đi lại, 600.000 hỗ trợ liên lạc.','2018-12-30',NULL,1),(4,'Hỗ trợ lãnh đạo công ty',2200000,'600.000 hồ trợ tiền ăn, 800.000 hỗ trợ đi lại, 800.000 hỗ trợ liên lạc.','2018-12-30',NULL,1);

/*Table structure for table `tbl_luong_tldn` */

DROP TABLE IF EXISTS `tbl_luong_tldn`;
...
/*Data for the table `tbl_luong_tldn` */

insert  into `tbl_luong_tldn`(`tldn_id`,`tldn_ten`,`tldn_heso`,`tldn_mota`,`tldn_date`,`tldn_sort`,`tldn_active`) values (1,'Bậc lương nhân viên 1',1.5,'Nhân viên thời vụ hoặc dưới 01 năm làm việc.','2018-12-30',NULL,1),(2,'Bậc lương nhân viên 2',2,'Từ 01 đến dưới 02 năm làm việc.','2018-12-30',0,1),(3,'Bậc lương nhân viên 3',3,'Từ 02 năm đến dưới 04 năm làm việc.','2018-12-31',0,1),(4,'Bậc lương nhân viên 4',5,'Từ 04 năm đến dưới 07 năm làm việc.','2018-12-31',NULL,1),(5,'Bậc lương nhân viên 5',6,'Trên 07 năm làm việc.','2018-12-31',0,1),(6,'Bậc lương quản lý 1',3,'Phó phòng/ban dưới 1 năm làm việc','2018-12-31',0,1),(7,'Bậc lương quản lý 2',5.5,'Phó phòng/ban trên 2 năm, trưởng phòng/ban dưới 2 năm','2018-12-31',0,1);

/*Table structure for table `tbl_luong_tlnn` */

DROP TABLE IF EXISTS `tbl_luong_tlnn`;
...
insert  into `tbl_modules`(`mod_id`,`mod_name`,`mod_desc`,`mod_date`,`mod_sort`,`mod_active`) values (259,'chat',NULL,NULL,0,0),(260,'config',NULL,NULL,0,0),(261,'congviecs',NULL,NULL,0,0),(262,'daydocs',NULL,NULL,0,0),(263,'departments',NULL,NULL,0,0),(264,'docs',NULL,NULL,0,0),(265,'hdsds',NULL,NULL,0,0),(266,'holidays',NULL,NULL,0,0),(267,'importants',NULL,NULL,0,0),(268,'interdiscis',NULL,NULL,0,0),(269,'kdls',NULL,NULL,0,0),(270,'modules',NULL,NULL,0,0),(271,'msgs',NULL,NULL,0,0),(272,'objects',NULL,NULL,0,0),(273,'plans',NULL,NULL,0,0),(274,'ports',NULL,NULL,0,0),(275,'secrets',NULL,NULL,0,0),(276,'signobjs',NULL,NULL,0,0),(277,'signpers',NULL,NULL,0,0),(278,'thamgia',NULL,NULL,0,0),(280,'trinhdos',NULL,NULL,0,0),(282,'units',NULL,NULL,0,0),(283,'users',NULL,NULL,0,0),(284,'vttbs',NULL,NULL,0,0),(285,'truyennhans',NULL,NULL,0,0),(288,'tthopdong',NULL,NULL,0,0),(289,'hdmua',NULL,NULL,0,0),(290,'tinhluong',NULL,NULL,0,0),(291,'hdban',NULL,NULL,0,0);
...
CREATE TABLE `tbl_users` (
  ...
  `user_mucluong` int(11) DEFAULT NULL,
  `user_phucap` int(11) DEFAULT NULL,
  ...
  `user_level` tinyint(1) DEFAULT '0' COMMENT '1. Quan tri, 2. van thu, 3. tro ly, 4. GD, 5. pho GD, 6. TP, 7. pho TP, 8. nhan vien, 10. van thu phong',
...
insert  into `tbl_users`(`user_id`,`department_id`,`unit_id`,`object_id`,`user_fullname`,`user_name`,`user_pass`,`user_encode_pass`,`user_phone`,`user_email`,`user_domain`,`user_image`,`user_sex`,`user_ngay_sinh`,`user_noi_sinh`,`user_thuong_tru`,`user_tam_tru`,`trinhdo_id`,`user_mucluong`,`user_phucap`,`user_cmnd`,`user_ngay_cap`,`user_noi_cap`,`user_ngay_bat_dau`,`user_so_tai_khoan`,`user_ngan_hang`,`per_add`,`per_edit`,`per_del`,`per_act`,`per_view`,`per_sms`,`user_module`,`user_sort`,`user_level`,`user_level_tnvb`,`user_level_soft`,`user_active`) values (1,'15,',15,6,'Quản trị','admin','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,'images/userimg/large_images/1361246911_P1040778.jpg',1,'1986-03-31','Từ Liêm, Hà Nội','Xuân Đỉnh, Từ Liêm, Hà Nội','Số 23, ktt X-827, thôn Tân Xuân, Xuân Đỉnh, Từ Liêm, HN',5,2,1,'012504687','2002-03-30','Công an TP. Hà Nội','2010-01-01','01035890624','0',NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,1,3,3,1),(31,'12,26,27,13,28,25,15,17,18,16,14,24,23,21,19,20,22,',12,1,'Nguyễn Văn Thanh','thanhnv','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'2015-11-20',NULL,NULL,NULL,2,1,1,NULL,'2015-11-20',NULL,'2015-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,4,3,3,1),(37,'12,26,27,13,28,25,15,17,18,16,14,24,23,21,19,20,22,',12,2,'Nguyễn Bá Vân','vannb','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'2014-02-22',NULL,NULL,NULL,1,4,4,NULL,'2014-02-22',NULL,'2010-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,5,3,3,1),(38,'12,26,27,13,28,25,15,17,18,16,14,24,23,21,19,20,22,',12,2,'Nguyễn Thăng Long','longnt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'2015-11-20',NULL,NULL,NULL,2,4,4,NULL,'2015-11-20',NULL,'2010-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,5,3,3,1),(39,'12,26,27,13,28,25,15,17,18,16,14,24,23,21,19,20,22,',12,2,'Vũ Đức Tòng','tongvd','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'2015-11-20',NULL,NULL,NULL,2,4,4,NULL,'2015-11-20',NULL,'2010-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,5,3,3,1),(40,'15,',15,6,'Văn thư','vanthu','e10adc3949ba59abbe56e057f20f883e','123456','01697613570','vanthu@hacinco.com.vn',NULL,NULL,1,'2015-11-20',NULL,NULL,NULL,2,1,1,NULL,'2015-11-20',NULL,'2010-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,2,3,3,1),(41,'13,',13,6,'Trợ lý','troly','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','troly@hacinco.com.vn',NULL,NULL,1,'--',NULL,NULL,NULL,2,1,1,NULL,'--',NULL,'2010-01-01',NULL,NULL,0,0,0,0,0,3,'0',0,3,3,3,1),(42,'15,',15,4,'Trưởng phòng HC','tphc','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'--',NULL,NULL,NULL,2,3,3,NULL,'--',NULL,'2010-01-01',NULL,NULL,0,0,0,0,0,3,'0',0,6,3,3,1),(43,'17,',17,4,'Trưởng phòng KHKT','tpkhkt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'--',NULL,NULL,NULL,2,3,3,NULL,'--',NULL,'2010-01-01',NULL,NULL,0,0,0,0,0,3,'0',0,6,3,3,1),(44,'26,',26,4,'Trưởng ban QLDA1','tbqlda1','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'--',NULL,NULL,NULL,2,3,3,NULL,'--',NULL,'2010-01-01',NULL,NULL,0,0,0,0,0,3,'0',0,6,3,3,1),(45,'27,',27,4,'Trưởng ban QLDA2','tbqlda2','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'--',NULL,NULL,NULL,2,3,3,NULL,'--',NULL,'2010-01-01',NULL,NULL,0,0,0,0,0,3,'0',0,6,3,3,1),(46,'23,',23,6,'Nhân viên Hacinco','hacinco','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','hacinco@hacino.com.vn',NULL,NULL,1,'2015-11-24',NULL,NULL,NULL,2,1,1,NULL,'2015-11-24',NULL,'2010-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,8,3,3,1),(47,'23,',23,3,'GĐXNDV Hacinco','gdhacinco','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','gdhacinco@hacinco.com.vn',NULL,NULL,1,'2018-12-16',NULL,NULL,NULL,2,5,4,NULL,'2018-12-16',NULL,'2010-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,NULL,6,3,3,1),(48,'15,',15,6,'Nhân viên HCQT','nvhcqt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'--',NULL,NULL,NULL,2,1,1,NULL,'--',NULL,'2010-01-01',NULL,NULL,0,0,0,0,0,3,'0',0,8,3,3,1),(49,'17,',17,6,'VT - KHKT','vt_khkt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'2016-02-17',NULL,NULL,NULL,2,1,1,NULL,'2016-02-17',NULL,'2016-02-17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,10,3,3,1),(50,'17,',17,6,'CV - KHKT','cv_khkt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,1,'2018-12-13',NULL,NULL,NULL,2,1,1,NULL,'2018-12-13',NULL,'2018-12-13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,8,3,3,1),(51,'15,',15,6,'Lê Thùy Dung','dunglt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,2,'--',NULL,NULL,NULL,2,1,1,NULL,'--',NULL,'2018-12-12',NULL,NULL,0,0,0,0,0,0,'0',0,8,3,3,1),(52,'15,',15,6,'Đàm Thùy Linh','linhdt','e10adc3949ba59abbe56e057f20f883e','123456','0972119746','anhvan3103@gmail.com',NULL,NULL,2,'--',NULL,NULL,NULL,2,1,1,NULL,'--',NULL,'2018-12-12',NULL,NULL,0,0,0,0,0,0,'0',0,8,3,3,1),(53,'16,',16,6,'Nguyễn Thu Trang','trangnt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,2,'--',NULL,NULL,NULL,2,1,1,NULL,'--',NULL,'2018-12-12',NULL,NULL,0,0,0,0,0,0,'0',0,8,3,3,1),(54,'16,',16,6,'Nguyễn Thu Hường','huongnt','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,2,'--',NULL,NULL,NULL,2,1,1,NULL,'--',NULL,'2018-12-12',NULL,NULL,0,0,0,0,0,0,'0',0,8,3,3,1),(55,'13,',13,6,'Thiều Hồng Liên','lienth','e10adc3949ba59abbe56e057f20f883e','123456','0972559746','anhvan3103@gmail.com',NULL,NULL,2,'--',NULL,NULL,NULL,2,1,1,NULL,'--',NULL,'2018-12-12',NULL,NULL,0,0,0,0,0,0,'0',0,8,3,3,1);
...
insert  into `tbl_vttb_cats`(`vttb_cat_id`,`vttb_cat_name`,`vttb_cat_ununicode`,`vttb_cat_date`,`vttb_cat_sort`,`vttb_cat_active`,`user_id`) values (1,'Vật tư thiết bị','Vat tu thiet bi','2013-04-18',0,1,1),(2,'Cơ sở vật chất','Co so vat chat','2013-04-18',0,1,1),(3,'Phương tiện','Phuong tien','2013-04-18',0,1,1),(5,'Các loại khác','Cac loai khac','2018-12-17',NULL,1,1),(6,'Danh mục mới','Danh muc moi','2013-06-22',0,1,1);
