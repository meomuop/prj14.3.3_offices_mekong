...
insert  into `tbl_config`(`config_id`,`owner_name`,`owner_add`,`owner_phone`,`owner_fax`,`owner_email`,`owner_reemail`,`owner_url`,`luong_coban`,`luong_apdung`,`ngay_macdinh`,`sat_ra`,`sun_ra`,`site_port`,`site_active`,`site_inactive_info`) values (1,'Tập đoàn MEKONG','Tầng 5, tòa nhà 21 T2, dự án Hapulico Complex, số 1 Nguyễn Huy Tưởng , Thanh Xuân Trung, Thanh Xuân, Hà Nội','(84-4)35584167','(84-4)35584201','info@mekong.net',NULL,'Mekong Group',2000000,NULL,'2018-12-30',2,2,'COM5',NULL,NULL);
...
insert  into `tbl_luong_tldn`(`tldn_id`,`tldn_ten`,`tldn_heso`,`tldn_mota`,`tldn_date`,`tldn_sort`,`tldn_active`) values (1,'Bậc lương nhân viên 1',1.5,'Nhân viên thời vụ hoặc dưới 01 năm làm việc.','2018-12-30',NULL,1),(2,'Bậc lương nhân viên 2',2,'Từ 01 đến dưới 02 năm làm việc.','2018-12-30',0,1);
