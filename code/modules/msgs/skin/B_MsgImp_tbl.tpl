...
<div id="msg_content_insign">
	<form method="post" name="frmList_Msg" action="?listMsgImp{$vars.arg}" id="frmList_Msg">
    <!------------------------------------MENU SMS---------------------------------------------->
    ...
    <fieldset style="width:380px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:272px">
        ...
        <div style="float:left; height:218px; width:380px; overflow-y:scroll">
            ...
            <div class="{$class_td}" style="width:259px;">
                ...
                {/php}
                <a href="javascript:void(0)" onclick="show_noidung_msg({$obj_list[mi]->msg_id},'listMsgImp')">
...
<script language="javascript">	
	...
	function search_me_Msg(){
		...
		$.post('?listMsgImp&mod=msgs&impmsg=1',
			{keyword:keyword},
			function(data){
	...
	function update_thuong(msg_id){
		...
		$('#msg_content_main').fadeOut('fast').load('index.php?listMsgImp&mod=msgs&impmsg=1').fadeIn("fast");	
	}
	...
	function loc_dl(msg_type){
		...
		$.post('?listMsgImp&mod=msgs&msg_type='+msg_type,
	...
	$("#a_ref_Msg").click( function () { 
		...
		$('#msg_content_main').hide();
		$('#msg_content_main').fadeOut('fast').load('index.php?listMsgImp&mod=msgs').fadeIn("fast");
	});
</script>
{/literal}