...
- Created by Le Anh Van - anhvan3103@gmail.com
	...
	$where .= " AND msg_id in(select msg_id from tbl_msgusers where user_id = ".$_SESSION['user_id']." and msgUser_type = 2)";
	$obj = new msg_class();
	...
	$display = dirname(__FILE__)."/skin/B_MsgRac_tbl.tpl";
	...
	$smarty->display(dirname(__FILE__)."/skin/B_MsgRac_tbl.tpl");
	else
