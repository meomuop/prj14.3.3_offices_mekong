...
--------------------------------------------*/
	...
	// --- Condition
	$where = " 1 = 1 AND user_sent = ".$_SESSION['user_id']." AND msg_id in(select msg_id from tbl_msgusers)";
	...
	$display = dirname(__FILE__)."/skin/B_Msg_tbl.tpl";
	...
	$smarty->display(dirname(__FILE__)."/skin/B_Msg_tbl.tpl");
	else
