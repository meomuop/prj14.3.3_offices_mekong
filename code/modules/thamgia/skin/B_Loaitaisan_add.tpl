                                               	...
                                               	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                 									<tr>
     													<td valign="top" align="center">
															 ...
															 <legend >&nbsp;Thêm mới loại tài sản&nbsp;&nbsp;</legend>	
                                                             {if $complete eq 1}
                                                                <div><img src="images/spacer.gif" height="30px" /></div>
                                                                <div align="center" class="complele_alert">
                                                                <h2>Thêm loại tài sản thành công</h2><br /><br />
                                                                </div>
                                                             {else}
                                                             <form action="?addLoaitaisan{$vars.arg}" method="POST" name="theForm">
                                                             {if $error neq ""}
															 ...
															 <div align="center">
							  								 <table width="95%">
                                                                    ...
                                                                    <font class="label_font" color="#425E89">Tình trạng :</font></td>		
								  									<td align="left">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr>
                                                                            <td width="20%">
                                                                            <input type="radio" id="loaitaisan_active" name="loaitaisan_active" value="1" checked/>&nbsp;Hiển thị</td>
                                                                            <td>
                                                                            <input type="radio" id="loaitaisan_active" name="loaitaisan_active" value="0"/>&nbsp;Không hiển thị</td>
                                                                          </tr>
                                                                        </table>
                                                                    </td>
																</tr>
																<tr>
                                                                    ...
                                                                    <input type="submit" name="submitLoaitaisan" value="Thêm mới"/>
