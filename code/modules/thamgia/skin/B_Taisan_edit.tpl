...
function loadFCK1()
{
	var oFCKeditor = new FCKeditor( 'taisan_desc' ) ;
                 									...
                 									<tr>
     													<td valign="top" align="center">
          	 												<table class="adminlist" width="100%" border="0" cellpadding="0" cellspacing="0">
																...
																<tbody>
                                                                <tr>
	  																<td  style="font-family: Arial; color:#930; font-size: 16px; font-weight: bold;" width="31%" nowrap="nowrap"><div align="left"><img src="../images/admin/module.png" align="absmiddle" height="30">&nbsp;Danh sách tài sản</div>
                                                                    </td>	
	  															</tr>
																</tbody>
   															 </table>
															 ...
															 <legend >&nbsp;Sửa tài sản&nbsp;&nbsp;</legend>	
                                                             {if $complete eq 1}
                                                                <div><img src="images/spacer.gif" height="30px" /></div>
                                                                <div align="center" class="complele_alert">
                                                                <h2>Sửa tài sản thành công</h2><br /><br />
                                                                </div>
                                                             {else}
                                                             <form action="?editTaisan{$arg.arg}" method="POST" name="theForm">
                                                             {if $error neq ""}
															 ...
															 <div align="center">
							  								 <table width="95%">
                                                             	<tr>
                                                                    ...
                                                                    <font class="label_font" color="#425E89">Tên tài sản *:</font></td>		
								  									<td align="left">
                                                                    <input type="text" id="taisan_name" name="taisan_name" size="50" value="{$vars.taisan_name}"/>
                                                                    </td>
																</tr>
                                                                <tr>
								  									<td width="30%" align="left" height="20">
                                                                    <font class="label_font" color="#425E89">Viết tắt *:</font></td>		
								  									<td align="left">
                                                                    <input type="text" id="taisan_standfor" name="taisan_standfor" size="50" value="{$vars.taisan_standfor}"/>
                                                                    </td>
																</tr>
                                                                <tr>
                                                                    <td align="left">
                                                                    ...
                                                                    <td align="left">
                                                                    <textarea name="taisan_desc" cols="30" rows="5" style="font-size:12px;width:60%; height:100px;">{$vars.taisan_desc}</textarea>
                                                                    {literal}
                                                                    ...
                                                                    <font class="label_font" color="#425E89">Kiểu :</font></td>		
								  									<td align="left">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr>
                                                                            <td width="20%">
                                                                            <input type="radio" id="taisan_type" name="taisan_type" value="1" {if $vars.taisan_type eq 1} checked="checked" {/if}/>&nbsp;Thẩm định giá</td>
                                                                            <td width="20%">
                                                                            <input type="radio" id="taisan_type" name="taisan_type" value="0" {if $vars.taisan_type eq 0} checked="checked" {/if}/>&nbsp;Bán đấu giá</td>
                                                                             <td>
                                                                            <input type="radio" id="taisan_type" name="taisan_type" value="2" {if $vars.taisan_type eq 2} checked="checked" {/if}/>&nbsp;Cả hai</td>
                                                                          </tr>
                                                                        </table>
                                                                    </td>
																</tr>
                                                                    ...
                                                                    <font class="label_font" color="#425E89">Tình trạng :</font></td>		
								  									<td align="left">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr>
                                                                            <td width="20%">
                                                                            <input type="radio" id="taisan_active" name="taisan_active" value="1" {if $vars.taisan_active eq 1} checked="checked" {/if}/>&nbsp;Hiển thị</td>
                                                                            <td>
                                                                            <input type="radio" id="taisan_active" name="taisan_active" value="0" {if $vars.taisan_active eq 0} checked="checked" {/if}/>&nbsp;Không hiển thị</td>
                                                                          </tr>
                                                                        </table>
                                                                    </td>
																</tr>
																<tr>
                                                                    ...
                                                                    <input type="submit" name="submitTaisan" value="Cập nhật"/>
                                                                    <input type="hidden" name="arg" value="{$arg.arg}" />
                                                                    <input type="hidden" name="taisan_id" value="{$vars.taisan_id}">
