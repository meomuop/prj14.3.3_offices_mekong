                                               	...
                                               	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                 									<tr>
     													<td valign="top" align="center">
															 ...
															 <legend >&nbsp;Sửa nguồn ngân sách&nbsp;&nbsp;</legend>	
                                                             {if $complete eq 1}
                                                                <div><img src="images/spacer.gif" height="30px" /></div>
                                                                <div align="center" class="complele_alert">
                                                                <h2>Sửa nguồn ngân sách thành công</h2><br /><br />
                                                                </div>
                                                             {else}
                                                             <form action="?editNgansach{$arg.arg}" method="POST" name="theForm">
                                                             {if $error neq ""}
															 ...
															 <div align="center">
							  								 <table width="95%">
                                                                    ...
                                                                    <font class="label_font" color="#425E89">Kiểu :</font></td>		
								  									<td align="left">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr>
                                                                            <td width="20%">
                                                                            <input type="radio" id="ngansach_type" name="ngansach_type" value="1" {if $vars.ngansach_type eq 1} checked="checked" {/if}/>&nbsp;Thẩm định giá</td>
                                                                            <td width="20%">
                                                                            <input type="radio" id="ngansach_type" name="ngansach_type" value="0" {if $vars.ngansach_type eq 0} checked="checked" {/if}/>&nbsp;Bán đấu giá</td>
                                                                             <td>
                                                                            <input type="radio" id="ngansach_type" name="ngansach_type" value="2" {if $vars.ngansach_type eq 2} checked="checked" {/if}/>&nbsp;Cả hai</td>
                                                                          </tr>
                                                                        </table>
                                                                    </td>
																</tr>
                                                                    ...
                                                                    <font class="label_font" color="#425E89">Tình trạng :</font></td>		
								  									<td align="left">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr>
                                                                            <td width="20%">
                                                                            <input type="radio" id="ngansach_active" name="ngansach_active" value="1" {if $vars.ngansach_active eq 1} checked="checked" {/if}/>&nbsp;Hiển thị</td>
                                                                            <td>
                                                                            <input type="radio" id="ngansach_active" name="ngansach_active" value="0" {if $vars.ngansach_active eq 0} checked="checked" {/if}/>&nbsp;Không hiển thị</td>
                                                                          </tr>
                                                                        </table>
                                                                    </td>
																</tr>
																<tr>
                                                                    ...
                                                                    <input type="submit" name="submitNgansach" value="Cập nhật"/>
                                                                    <input type="hidden" name="arg" value="{$arg.arg}" />
                                                                    <input type="hidden" name="ngansach_id" value="{$vars.ngansach_id}">
