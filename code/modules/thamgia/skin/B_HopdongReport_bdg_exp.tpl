...
<table style="width:750px" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="25"><td align="center"><b>BẢNG BÁO CÁO<br />(CÔNG VĂN, GIẤY ĐỀ NGHỊ BÁN ĐẤU GIÁ)</b></td></tr>
...
<table style="width:750px" border = "1" align="center" class="adminlist">
	...
	<tr bgcolor="#EEEEEE" >
       ...
       <td align="center" colspan="5">Công văn, giấy đề nghị bán đấu giá</td>	
    ...
    <tr height="25" bgcolor="#EEEEEE" >
      ...
      <td align="center">Tổ chức cá nhân đề nghị bán đấu giá</td>
      <td width="150" align="center">Loại TS để nghị bán đấu giá</td>
    </tr>
	...
	{/section}
    <tr height="30"><td colspan="6" align="right">Tổng số:</td><td align="right">{$total_num}</td></tr>
	...
	{/section}
    <tr height="30"><td colspan="6" align="right">Tổng số:</td><td align="right">{$total_num_huy}</td></tr>
    <tr height="30"><td colspan="7"></td></tr>
    <tr>
    	<td colspan="4" align="right" height="100"></td>
...
<table style="width:750px" border="0" cellspacing="0" cellpadding="0">
    <tr height="25"><td align="center" style="font-size:16px"><b>CÔNG TY CP THẨM ĐỊNH GIÁ HÀ NỘI</b></td></tr>
    <tr height="25">
        <td align="center"><b>BẢNG BÁO CÁO<br />(TÌNH HÌNH HỢP ĐỒNG ĐANG TIẾN HÀNH BÁN ĐẤU GIÁ)</b></td>
    </tr>
    <tr height="25">
        <td align="center">
...
<table style="width:750px" border = "1" align="center" class="adminlist">
	<tr bgcolor="#EEEEEE" >
       <td width="20" align="center" rowspan="2">STT</td>
       <td width="120" align="center" rowspan="2">Tên tổ chức/cá nhân đề nghị bán đấu giá</td>
       <td width="120" align="center" rowspan="2">Loại tài sản đề nghị bán đấu giá</td>
       <td align="center" colspan="3">Công văn, giấy đề nghị</td>
	...
	{/section}
    <tr height="30"><td colspan="8" align="right">Tổng số:</td><td align="right">{$total_num}</td></tr>
    <tr height="30"><td colspan="9"></td></tr>
    <tr>
    	<td colspan="6" align="right" height="100"></td>
    	<td colspan="3" align="center" height="100">
        	Hà Nội, ngày {$smarty.now|date_format:"%d"} tháng {$smarty.now|date_format:"%m"} năm {$smarty.now|date_format:"%Y"}<br />
            Người làm báo cáo<br />
            {$access_object_name}<br /><br /><br /><br /><br /><br />
...
<table style="width:1000px" border="0" cellspacing="0" cellpadding="0">
    <tr height="25"><td align="center" style="font-size:16px"><b>CÔNG TY CP THẨM ĐỊNH GIÁ HÀ NỘI</b></td></tr>
    <tr height="25">
        <td align="center"><b>BẢNG BÁO CÁO<br />(KẾT QUẢ CÔNG VIỆC BÁN ĐẤU GIÁ ĐÃ THỰC HIỆN)</b></td>
    </tr>
    <tr height="25">
        <td align="center">
            <i>Thời gian: Từ ngày {$tu_ngay|date_format:"%d/%m%Y"} đến ngày {$den_ngay|date_format:"%d/%m%Y"}</i>
...
<table style="width:1000px" border = "1" align="center" class="adminlist">
	<tr bgcolor="#EEEEEE" >
       ...
       <td align="center" colspan="2">Hợp đồng</td>
       <td width="80" align="center" rowspan="2">Số thanh lý</td>
       <td width="90" align="center" rowspan="2">Ghi chú</td>
	</tr>
    <tr height="25" bgcolor="#EEEEEE" >
      <td width="40" align="center">Ngày nhận</td>
	...
	{/section}
    <tr height="30"><td colspan="10" align="right">Tổng số:</td><td align="right">{$total_num}</td></tr>
    <tr height="30"><td colspan="11"></td></tr>
    <tr>
    	<td colspan="8" align="right" height="100"></td>
    	<td colspan="3" align="center" height="100">
        	Hà Nội, ngày {$smarty.now|date_format:"%d"} tháng {$smarty.now|date_format:"%m"} năm {$smarty.now|date_format:"%Y"}<br />
            Người làm báo cáo<br />
            {$access_object_name}<br /><br /><br /><br /><br /><br />
