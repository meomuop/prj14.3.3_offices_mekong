...
<div id="cv_cat_content_insign">
    <form method="post" name="frmList_CvCat" action="?listCvCat{$vars.arg}" id="frmList_CvCat">
        ...
        <div style="float:left">
            <fieldset style="width:289px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:482px">
                ...
                <div style="float:left; height:455px; width:289px; overflow-y:scroll">
                    {section name=pi loop=$obj_list}
                        ...
                        <div style="float:left; line-height:30px; border-bottom: 1px dashed #99bbe8">
                            ...
                            <div style="float:left; width:247px; white-space:nowrap" title="{$obj_list[pi]->cv_cat_name}">
                                <div style="float:left; width:225px; white-space:nowrap">
                                    <a href="javascript:void(0);" onclick="javascript: show_cv_luong_xl({$obj_list[pi]->cv_cat_id})" style="{if $cv_cat_id eq $obj_list[pi]->cv_cat_id}color:#F00{/if}{if $obj_list[pi]->cv_cat_priority eq 1}; font-weight:bold{/if}" >{$obj_list[pi]->cv_cat_name|str_string_cut:"55":"1"}</a>
                                </div>
                                ...
                                <div id="extra_cv_cat_{$count}" style="position:absolute; display:none; height:auto; width:60px; margin:2px 166px; border:1px solid #8ea4c1; border-right:1px solid #8ea4c1; background-color:#dfe8f6">
        ...
        <!------------------------------------LUONG XU LY-------------------------------------------->
        <div style="float:left">
            <fieldset style="width:620px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:482px">
                ...
                <div style="float:left; height:5px; width:100%"></div>
                <div style="float:left; height:452px; width:615px; padding:2px; overflow-y:scroll">
                                            ...
                                            <div style="float:left">
                                                <div style="float:left; width:200px; height:20px; ">
                                                    ...
                                                    <div style="float:left; width:180px">
                                                        <div style="float:left; width:155px; height:20px; line-height:20px; white-space:nowrap; border:1px solid #99bbe8; white-space:nowrap; background-color:#FFF" title="{php}echo $row['cv_sub_name'].'&#13;'.$row['cv_sub_desc']{/php}">
                                                            &nbsp;{php}echo fnsSubstr(str_replace(array('Phòng','Ban'),array('P.','B.'),$row['department_name']),32,1){/php}
                                                        </div>
                                                        {php}if($row['department_id']==$this->_tpl_vars['access_unit_id'] && ($this->_tpl_vars['user_level'] == 3 || $this->_tpl_vars['user_level'] == 6)):{/php}
                                                ...
                                                <div style="float:left; width:200px; height:auto;">
                                                    <div style="float:left; width:200px; padding-left:20px; font-style:italic">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td align="left" width="30%" valign="top">
                                                        ...
                                                        <div style="float:left; width:173px; height:20px">
                                                            ...
                                                            <div style="float:left; width:154px">
                                                                <div style="float:left; width:130px; height:20px; line-height:20px; white-space:nowrap; border:1px solid #99bbe8; white-space:nowrap; background-color:#FFF" title="{php}echo $row_index['cv_index_name'].'&#13;'.$row_index['cv_index_desc']{/php}">
                                                                    &nbsp;{php}echo fnsSubstr($row_index['user_fullname'],35,1){/php}
                                                                </div>
                                                                <div style="width:20px; float:left; margin-top:2px; height:20px;">
                                                                    {php}if($row_index['user_id']==$this->_tpl_vars['access_user_id'] && ($this->_tpl_vars['user_level']==6 || $this->_tpl_vars['user_level'] == 3)):{/php}
                                                        ...
                                                        <div style="float:left; width:173px; height:{php} echo $height_bot_log.'px'{/php}; {php}if($j<mysql_num_rows($result_index)-1):{/php}border-left:1px solid #99bbe8{php}endif;{/php}">
                                                            <div style="float:left; width:154px; padding-left:20px; font-style:italic">
                                                                <div style="width:22px; float:left; margin-top:3px; height:20px">
