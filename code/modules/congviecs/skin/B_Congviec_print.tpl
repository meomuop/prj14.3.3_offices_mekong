...
<div id="report_congviec_content_insign">
    <form method="post" name="frmList_CvCat" action="?listCvCat{$vars.arg}" id="frmList_CvCat">
        ...
        <div style="float:left">
            ...
            <div style="float:left; height:auto; width:733px; padding:2px">
                <div style="float:left; width:718px; height:auto" id="div_cont_print">
                    {literal}
                        <style type="text/css">
                            ...
                            .tbl_tit{
                                float:left; line-height:25px; border-right:1px solid #99bbe8; font-family: arial, helvetica, sans-serif;
                            }
                            .tbl_cont{
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="left" valign="top" width="5%" style="width:75px; padding-bottom: 10px">
                                <div style="float:left; width:75px;">
                                    ...
                                    {/php}
                                    <div style="float:left; width:75px;">
                                        <div style="width:50px; float:left; height:auto; line-height: 20px; text-align: center; border:1px solid #99bbe8; background-color: #fff">
                                            {php}
                                        ...
                                        <div style="width:19px; float:left; height:auto; border-top:1px solid #99bbe8;"></div>
                                    </div>
                                </div>
                            </td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="left" width="30%" valign="top" style="background-color: {php}echo $bg;{/php}; display: {php}echo $displaycv;{/php}">
                                                                    <div style="float:left; width:482px; height:auto;{php}if($k<mysql_num_rows($result_log)-1):{/php}border-left:1px solid #99bbe8{php}endif;{/php}">
                                                                        ...
                                                                        <div style="float:left; width:462px">
                                                                            <div style="float:left; width:462px; height:auto; line-height:20px; white-space:normal; border:1px solid #99bbe8; background-color: #fff; white-space:nowrap" title="{php}echo $row_log['cv_log_desc'].'&#13;'.$row_log['cv_log_note']{/php}">
                                                                                <div style="float:left; width:438px; line-height:18px; white-space:normal; margin-left: 2px">
                                                                                    {php}if(($row['department_id']==$this->_tpl_vars['access_unit_id'] && $this->_tpl_vars['user_level'] == 6) || $this->_tpl_vars['user_level'] == 4):{/php}
                                                                                ...
                                                                                <div style="float:left; width:470px">
                                                                                    ...
                                                                                    echo '<div style="float:left"><div style="float:left; width: 100%">&nbsp;- Lãnh đạo phụ trách:</div>';
                                                                                        ...
                                                                                        {/php}
                                                                                        <div style="float:left; width:135px">
                                                                                            <div style="float:left; width:auto; height:20px; line-height:20px; white-space:nowrap; white-space:nowrap; background-color: #fff">
                                                                                                &nbsp;<i>{php}echo $row_ldpt['user_fullname']{/php}</i>
                                                                                            </div>
                                                                                        </div>
                                                                                        {php}
                                                                                        $i++;
                                                                                ...
                                                                                <div style="float:left; width:470px">
                                                                                    ...
                                                                                    echo '<div style="float:left"><div style="float:left; width: 100%">&nbsp;- Đơn vị phối hợp:</div>';
                                                                                        ...
                                                                                        <div style="float:left; width:135px">
                                                                                            <div style="float:left; width:auto; height:20px; line-height:20px; white-space:nowrap; white-space:nowrap; background-color:#FFF">
                                                                                                &nbsp;<i>{php}echo fnsSubstr(str_replace(array('Phòng','Ban'),array('P.','B.'),$row_dvph['department_standfor']),32,1){/php}</i>
                                                                                            </div>
                                                                                        </div>
                                                                                        {php}
                                                                                            $i++;
                                                                        ...
                                                                        <div style="float:left; width:462px; height:10px;">
                                                                            <div style="float:left; width:462px; height:10px; {php}if($k<mysql_num_rows($result_log)-1):{/php}border-left:1px solid #99bbe8{php}endif;{/php}; line-height:25px; padding-left:20px">
