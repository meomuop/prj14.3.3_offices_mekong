...
<div id="list_replace_content_insign">
    ...
    <fieldset style="width:360px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px">
        ...
        {/if}
        {/section}
        <legend class="legend" style="width:250px">Thêm/Sửa mục thay thế cho: <span style="color:#00F" title="{$vttb_name}">{$vttb_name|str_string_cut:"45":"1"}</span></legend>
    ...
    <fieldset style="width:360px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:167px">
        ...
        <div style="float:left; height:112px; width:359px; overflow-y:scroll">
            ...
            <div style="float:left">
                ...
                <div class="{$class_td}" style="width:178px; white-space:nowrap" title="{$obj_list[pi]->vttb_replace_name}">
                	{if $obj_list[pi]->user_id eq $access_user_id}
                    &nbsp;<a href='javascript: void(0);' onclick="edit_me_Replace({$obj_list[pi]->vttb_replace_id},{$vttb_sub_id})">{$obj_list[pi]->vttb_replace_name|str_string_cut:"25":"1"}</a>
