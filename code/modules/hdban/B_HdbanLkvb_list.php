...
--------------------------------------------*/
	...
	if($vars['edit_me']==1):
        ...
        if (!$obj->lkvb_id) redirect("?listHdbanLkvb".$arg['arg']);
        $obj_info = (array)$obj;
	...
	$display = dirname(__FILE__)."/skin/B_HdbanLkvb_tbl.tpl";
	...
	$smarty->display(dirname(__FILE__)."/skin/B_HdbanLkvb_tbl.tpl");
	else
