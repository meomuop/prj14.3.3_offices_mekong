...
--------------------------------------------*/
	...
	if($vars['nhapxuattu'] && $vars['nhapxuatden']){
        $obj = new hdbanXuatkho_class();
        $obj_list = $obj->getTonkhoExport($vars['nhapxuattu'],$vars['nhapxuatden']);
	...
	$display = dirname(__FILE__)."/skin/B_HdbanXuatkho_exp.tpl";
	...
	$smarty->display(dirname(__FILE__)."/skin/B_HdbanXuatkho_exp.tpl");
	else
