...
<div id="hdban_content_insign">
	<form method="post" name="frmList_HdbanHoadon" action="?listHdbanHoadon{$vars.arg}" id="frmList_HdbanHoadon">
    <!------------------------------------------THEM MOI------------------------------------>
    <fieldset style="width:1012px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px">
        <legend class="legend_list_search" style="width: 600px">
            ...
            <span id="lblError_HdbanHoadon" class="error">(*) là các mục bắt buộc!</span>
        </legend>
            ...
            <tr height="30">
            	<td align="center" width="24%" valign="top">
                    ...
                    <div style="float:left; width:65%; line-height:25px; text-align:left">
                        <input type="text" id="hoadon_sohd" name="hoadon_sohd" class="text_short" value="{$obj_info.hoadon_sohd}" tabindex="1" onfocus="hide_message_HdbanHoadon();"/>
                    </div>
                    <div style="float:left; width:35%; line-height:25px; text-align:left">Ngày xuất <font color="#FF0000">*</font>:</div>
                    <div style="float:left; width:65%; line-height:25px; text-align:left">
                        <input type="text" name="hoadon_ngayhd" id="hoadon_ngayhd" class="text_time_callender" value="{$obj_info.hoadon_ngayhd|date_format:'%d/%m/%Y'}" tabindex="2" onfocus="hide_message_HdbanHoadon();"/>&nbsp;<img src="../images/admin/img.gif"  align="absmiddle" id="date_hoadon_ngayhd" style="cursor: pointer; border: 0" title="Chọn ngày trên lịch"/>
                        {literal}
                            <script type="text/javascript">
                                Calendar.setup({
                ...
                <td align="center" width="32%" valign="top">
                    ...
                    <div style="float:left; width:65%; line-height:25px; text-align:left">
                        <input type="text" class="text_short" name="hoadon_file" id="hoadon_file" value="{$obj_info.hoadon_file}" onfocus="hide_message_HdbanHoadon();">&nbsp;<a href="javascript:void(0)" onclick="javascript:window.open('upload_hdban_hoadon.php','new_page','width=420,height=245')" >[ Tải lên ]</a>
                    </div>
                    <div style="float:left; width:35%; line-height:25px; text-align:left">&nbsp;</div>
                    <div style="float:left; width:65%; line-height:25px; text-align:left">
                        <input type="button" name="btnSub_HdbanHoadon" id="btnSub_HdbanHoadon" value="Ghi lại" class="button" tabindex="18"/>
                ...
                <td align="center" valign="top">
                    ...
                    <div style="float:left; width:85%; line-height:25px; text-align:left; height:50px">
                        <textarea spellcheck="false" name="hoadon_noidung" id="hoadon_noidung" cols="30" rows="5" class="text_area_small" onfocus="hide_message_Hdban()" tabindex="8">{$obj_info.hoadon_noidung}</textarea>
                    </div>
                    <div style="float:left; width:15%; line-height:25px; text-align:left">Hợp đồng:</div>
                    <div style="float:left; width:55%; line-height:25px; text-align:left">{$hdban_info.hdban_sohd} (Ngày ký: {$hdban_info.hdban_ngayhd|date_format:"%d/%m/%Y"})</div>
                ...
                {literal}
                    <script language="javascript">
                        function hide_message_HdbanHoadon(){
                            $('#lblMessage_HdbanHoadon').hide();
                            $('#lblError_HdbanHoadon').hide();
                            $('#mess_doc').hide();
                        }
                        ...
                        $(function() {
                            ...
                            $("#btnSub_HdbanHoadon").click(function() {

                                $('.error').hide();

                                var $form = $("#frmList_HdbanHoadon");
                                ...
                                if (hoadon_sohd == "" || hoadon_ngayhd == "" || hoadon_giatri == "" ){
                                    $('#lblError_HdbanHoadon').show();
                                }
                                else{
                                    $.post('index.php?listHdbanHoadon&mod=hdban&add_edit=1',
                                        {
    ...
    <fieldset style="width:1012px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:322px">
        <legend class="legend_list" style="width:885px">
            ...
            <div style="width:45px; float:left">
                <input type="button" name="btnSeek" id="btnSeek" value="Tìm >>" class="button_seek" onclick="search_me_HdbanHoadon()" />
            </div>
            <!-----------------------------------------KET XUAT--------------------------------------->
        ...
        <div style="float:left; height:25px; width:990px; border-top:1px solid #99bbe8; border-bottom:1px solid #99bbe8 ">
            ...
            <input type="hidden" name="chon" id="chon_HdbanHoadon">
            <input type="checkbox" name="chkall" value="0" onclick="docheck_HdbanHoadon(document.frmList_HdbanHoadon.chkall.checked,0);">
            </div>
        </div>
        <div style="float:left; width:20px; text-align:right">
        <input type="button" name="del_Items" id='del_Items' value="&nbsp;" onClick="delItems_HdbanHoadon('{$processurl}');" style="width:17px; font-size:12px; background:url(../images/admin/b_drop.png); cursor:pointer" title="Xóa lựa chọn">
        </div>
        <div style="float:left; height:269px; width:1012px; overflow-y:scroll">
            ...
            <div style="float:left">
                ...
                <div class="{$class_td}" style="width:270px" title="{$obj_list[pi]->hoadon_noidung}">
                    ...
                    <div style="float:left; width:248px; white-space:nowrap">&nbsp;<a href="javascript: void(0);" onclick="edit_me_HdbanHoadon({$obj_list[pi]->hoadon_id})" >{$obj_list[pi]->hoadon_noidung|str_string_cut:"60":"1"}</a></div>
                ...
                <div class="{$class_td}" style="width:29px; text-align:center">
                    <a href='javascript: void(0);' onclick="edit_me_HdbanHoadon({$obj_list[pi]->hoadon_id})">
                    <img src="../images/admin/b_edit.png" width="11" height="11" border="0" title="Sửa"></a>
                </div>
                <div class="{$class_td}" style="width:29px; text-align:center">
                    <a href='javascript: void(0)' onClick="delItems_HdbanHoadon('{$processurl}', {$obj_list[pi]->hoadon_id});">
                    <img src="../images/admin/b_drop.png" width="11" height="11" border="0" title="Xóa"></a>
                </div>
                <div class="{$class_td}" style="width:30px; text-align:center">
                    <input type="checkbox" name="chkid" value="{$obj_list[pi]->hoadon_id}" onclick="docheckone_HdbanHoadon();">
                </div>
            </div>
            {/section}
        </div>
        <input type="hidden" id="curpage_HdbanHoadon" name="curpage" value="{$vars.curpage}" />
...
<div id="hdban_tool_bar">
    ...
    <select name="order" id = "order_HdbanHoadon" style="width:120px; font-size:12px; border:1px solid #99bbe8; margin-left:1px" onchange="reloadPage_HdbanHoadon('{$processurl}');">
    ...
    {else}
    <a href="javascript: void(0)" id="first_page" onclick="gotoPage_HdbanHoadon('{$processurl}',parseInt(1));" title="Trang đầu">
    	<img src="{$css_path}icon_first_page.png" class="img_all">
    </a>
    <a href="javascript: void(0)" id="pre_page" onclick="gotoPage_HdbanHoadon('{$processurl}',parseInt(document.getElementById('page_HdbanHoadon').value)-parseInt(1));" title="Trang trước">
    	<img src="{$css_path}icon_pre_page.png" class="img_all">
    </a>
    {/if}
    </div>
    <div style="float:left; line-height:19px">
        ...
        <input type="text" value="{$vars.curpage}" name="page" id="page_HdbanHoadon" onblur=" gotoPage_HdbanHoadon('{$processurl}',this.value);" style="width:30px; font-size:12px; height:15px; border:1px solid #99bbe8">
        </div>
    ...
    {else}
    <a href="javascript: void(0)" id="next_page" onclick="gotoPage_HdbanHoadon('{$processurl}',parseInt(document.getElementById('page_HdbanHoadon').value)+parseInt(1));" title="Trang tiếp">
    	<img src="{$css_path}icon_next_page.png" class="img_all">
    </a>
    <a href="javascript: void(0)" id="last_page" onclick="gotoPage_HdbanHoadon('{$processurl}',parseInt({$num_page}));" title="Trang cuối">
    	<img src="{$css_path}icon_last_page.png" class="img_all">
    </a>
    {/if}
    </div>
    ...
    <a href="javascript: void(0)" id="a_ref_HdbanHoadon" title="Tải lại"><img src="{$css_path}icon_refresh.png" class="img_all"></a>
    </div>
    ...
    <div style="float:right; line-height:19px; margin-right:2px">
        ...
        <div style="float:left; width:52px">
            <select name="numresult" id="numresult_HdbanHoadon" style="width:50px; font-size:12px; border:1px solid #99bbe8" onchange="reloadPage_HdbanHoadon('{$processurl}');">
...
<script language="javascript">	
	...
	function docheck_HdbanHoadon(status,from_){
		var alen=document.frmList_HdbanHoadon.elements.length;
		alen=(alen>5)?document.frmList_HdbanHoadon.chkid.length:0;
		if (alen>0){
			for(var i=0;i<alen;i++)
			document.frmList_HdbanHoadon.chkid[i].checked=status;
		}
		else{
			document.frmList_HdbanHoadon.chkid.checked=status;
		}
		if(from_>0) document.frmList_HdbanHoadon.chkall.checked=status;
	}
		
	function docheckone_HdbanHoadon(){
		var alen=document.frmList_HdbanHoadon.elements.length;
		var isChecked=true;
		alen=(alen>4)?document.frmList_HdbanHoadon.chkid.length:0;
		if (alen>0){
			for(var i=0;i<alen;i++)
				if(document.frmList_HdbanHoadon.chkid[i].checked==false)
					isChecked=false;
		}else{
			if(document.frmList_HdbanHoadon.chkid.checked==false)
				isChecked=false;
		}				
		document.frmList_HdbanHoadon.chkall.checked=isChecked;
	}
	
	function calculatechon_HdbanHoadon(){			
		var strchon="";
		var alen=document.frmList_HdbanHoadon.elements.length;				
		alen=(alen>2)?document.frmList_HdbanHoadon.chkid.length:0;
		if (alen>0){
			for(var i=0;i<alen;i++)
				if(document.frmList_HdbanHoadon.chkid[i].checked==true)
					strchon+=document.frmList_HdbanHoadon.chkid[i].value+",";
		}else{
			if(document.frmList_HdbanHoadon.chkid.checked==true)
				strchon=document.frmList_HdbanHoadon.chkid.value;
		}
		document.frmList_HdbanHoadon.chon_HdbanHoadon.value=strchon;
	}
	
	function delItems_HdbanHoadon(processurl,delStr){
		if (delStr == undefined){
			calculatechon_HdbanHoadon();
			delStr = document.getElementById("chon_HdbanHoadon").value;
		}
		if (delStr == ""){
			return false;
		}
		...
		var numresult_HdbanHoadon,order_HdbanHoadon,curpage_HdbanHoadon;
		numresult = $("#numresult_HdbanHoadon").val();
		order = $("#order_HdbanHoadon").val();
		curpage = $("#curpage_HdbanHoadon").val();
	...
	function reloadPage_HdbanHoadon(processurl){
		var numresult_HdbanHoadon,order_HdbanHoadon,cur_pos;
		numresult = $("#numresult_HdbanHoadon").val();
		order = $("#order_HdbanHoadon").val();
		cur_pos = 0;
	...
	function search_me_HdbanHoadon(){
		...
		$.post('?listHdbanHoadon&mod=hdban&search_me=1',
			{
	...
	function export_doc(exptype){
		...
		if(exptype==3){
			...
			$.post('?expHdbanHDReport&mod=hdban&exptype='+exptype,
				{
					ngayxuat:ngayxuat,
					denngay:denngay,
			...
			$('#hdban_content_main').fadeOut('fast').load('index.php?listHdbanHoadon&mod=hdban').fadeIn("fast");
			//$('#hdban_report_content_main').load("?expHdbanHDReport&mod=hdban&exptype="+exptype+"&ngayxuat="+ngayxuat+"&denngay="+denngay);
		}else{
			window.location="?expHdbanHDReport&mod=hdban&exptype="+exptype+"&ngayxuat="+ngayxuat+"&denngay="+denngay;
		}
	}
	
	function edit_me_HdbanHoadon(id){
		$("#hdban_content_main").load("?listHdbanHoadon&mod=hdban&edit_me=1&hdban_id="+id);
	}
		
	$("#a_ref_HdbanHoadon").click( function () { 
			$('#hdban_content_main').hide();
			$('#hdban_content_main').fadeOut('fast').load('index.php?listHdbanHoadon&mod=hdban').fadeIn("fast");
		});
</script>
