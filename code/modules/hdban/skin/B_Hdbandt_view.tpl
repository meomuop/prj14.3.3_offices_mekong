...
{/literal}
<div id="view_hdban_content_insign">
	<form method="post" name="frmList_HdbanView" action="?listHdbanView{$vars.arg}" id="frmList_HdbanView">
        <div style="float: left;">
            <!------------------------------------------Thong tim hop dong------------------------------------>
            <fieldset style="width:360px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:378px">
                <legend class="legend_list_search" style="width: 240px">Thông tin hợp đồng: {$hdban_info.hdban_sohd}</legend>
                        ...
                        <td style="line-height: 20px">
                            <div style="float: left; width: 100%; height:356px; overflow-y:scroll">
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Ngày ký:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.hdban_ngayhd|date_format:"%d/%m/%Y"}</div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Hiệu lực:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.hdban_hieuluc|date_format:"%d/%m/%Y"}</div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Nội dung:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.hdban_noidung}</div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%" title="Thời gian thực hiện"><u>TGTH:</u></div>
                                    <div style="float: left; width: 78%">
                                        {$hdban_info.hdban_tgth}
                                        {if $hdban_info.hdban_kieu_tgth eq 1}ngày
                                        {elseif $hdban_info.hdban_kieu_tgth eq 2}tháng
                                        {else}năm{/if}
                                    </div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%" title="Giá trị hợp đồng"><u>GTHĐ:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.hdban_giatri_quydoi|price_format} (VNĐ)</div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%" title="Giá trị thanh toán"><u>GTTT:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.hdban_gttt_quydoi|price_format} (VNĐ)</div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Khách hàng:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.khachhang_viettat}</div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Phụ trách:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.phongban_name}</div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Theo dõi:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.nguoi_theodoi}</div>
                                </div>
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Tình trạng</u></div>
                                    <div style="float: left; width: 78%">
                                        {if $hdban_info.hdban_tinhtrang eq 1}Mới nhập
                                        {elseif $hdban_info.hdban_tinhtrang eq 2}Đang thực hiện
                                        {elseif $hdban_info.hdban_tinhtrang eq 3}Đã hoàn thành
                                        {else}Đã hủy{/if}
                                    </div>
                                </div>
                                {if $hdban_info.hdban_tinhtrang eq 4}
                                    <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                        <div style="float: left; width: 22%">Thanh toán hủy</div>
                                        <div style="float: left; width: 78%">{$hdban_info.hdban_tl_huybo|price_format} (VNĐ)</div>
                                    </div>
                                    <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                        <div style="float: left; width: 22%">Lý do hủy</div>
                                        <div style="float: left; width: 78%">{$hdban_info.hdban_lydo_huybo}</div>
                                    </div>
                                {/if}
                                <div style="float: left; width: 100%; margin-top: 5px; border-bottom: 1px dashed #99bbe8">
                                    <div style="float: left; width: 22%"><u>Nội dung:</u></div>
                                    <div style="float: left; width: 78%">{$hdban_info.hdban_dieukhoankhac}</div>
                                </div>
                            </div>
                        </td>
                    </tr>
