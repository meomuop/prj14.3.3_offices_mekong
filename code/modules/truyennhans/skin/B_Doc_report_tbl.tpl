...
<table class="adminlist" width="1500" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td style="font-family: Arial; color:#930; font-size: 16px; font-weight: bold;" width="30%">
        	<div align="left"><img src="../images/admin/module.png" align="absmiddle" height="30">&nbsp;Báo cáo tổng thể</div>
        </td>	
        <td>
        	<div style="text-align: left; padding-bottom: 3px;">
                <div style="padding-bottom: 3px; ">
                    ...
                    <a href="?expDocReport{$vars.arg}&exptype=1">Kết xuất Microsoft Excel (.xls)</a> | <a href="?expDocReport{$vars.arg}&exptype=3">Kết xuất Microsoft Word (.doc)</a> | <a href="?detailReport{$vars.arg}">Báo cáo chi tiết</a>
                    </div>
                </div>
            </div>
        </td>		
