...
--------------------------------------------*/
	...
	if($order_id == 0):
		$where .=" AND doc_replied = 1 and user_id != ".$_SESSION['user_id']." and process_per = ".$_SESSION['user_id']." and docReply_active IN(0,2) and docReply_traned = 0 and doc_active = 2";
	elseif($order_id == 1):
		$where .= " AND doc_replied = 1 and user_id != ".$_SESSION['user_id']." and process_per = ".$_SESSION['user_id']." and docReply_active IN(0,2) and doc_active = 1";
	endif;
	...
	$display = dirname(__FILE__)."/skin/B_Doc_finish_tbl.tpl";
	...
	$smarty->display(dirname(__FILE__)."/skin/B_Doc_finish_tbl.tpl");
	else
