...
--------------------------------------------*/
	...
	// --- Condition
	$where = " 1 = 1 and docReply_limit_time < '".date('Y-m-d')."' and (doc_note_date > docReply_limit_time or doc_note_date = '0000-00-00') ";
	...
	$display = dirname(__FILE__)."/skin/B_BCVBDen_cham_exp.tpl";
	$assign_list['display'] = $display;
	
	$smarty->assign($assign_list);
	// --- Display template
	if (isset($vars['activeAjax']))
	$smarty->display(dirname(__FILE__)."/skin/B_BCVBDen_cham_exp.tpl");
	else
