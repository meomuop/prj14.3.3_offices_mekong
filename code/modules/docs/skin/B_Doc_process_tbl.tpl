...
<div id="doc_content_insign">
	<form method="post" name="frmList_Doc" action="?processDoc{$vars.arg}" id="frmList_Doc">
    <!------------------------------------DANH SACH---------------------------------------------->
    <fieldset style="width:912px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:462px">
        <legend class="legend_list" style="width:865px">
            ...
            <div style="width:380px; float:left; font-weight:normal; position:absolute; display:none; margin:20px 0 0 200px; background-color:#ccd8e7; border:1px solid #99bbe8; border-top:none" id="seek_more">
            ...
            <div style="width:260px; float:left; font-weight:normal; position:absolute; display:none; margin:20px 0 0 604px; background-color:#ccd8e7; border:1px solid #99bbe8; border-top:none; z-index:2010" id="div_filter">
        ...
        <div style="float:left; height:25px; width:890px; border-top:1px solid #99bbe8; border-bottom:1px solid #99bbe8 ">
            ...
            <div class="tbl_tit" style="width:370px"><B>&nbsp;Trích yếu</B></div>
        ...
        <div style="float:left; height:404px; width:912px; overflow-y:scroll">
            ...
            <div style="float:left">
                ...
                <div class="{$class_td}" style="width:50px; white-space:nowrap; text-align:right">
                    &nbsp;{$obj_list[pi]->doc_num}&nbsp;
                </div>
                ...
                <div class="{$class_td}" style="width:370px" title="{$obj_list[pi]->doc_desc}">
                	{math a=$smarty.section.pi.index b=1 equation="a+b" assign=count}
                    <div style="float:left; width:325px; white-space:nowrap">&nbsp;<a href="javascript: void(0);" onclick="show_thongtin_vanban({$obj_list[pi]->doc_id})" >{$obj_list[pi]->doc_desc|str_string_cut:"78":"1"}</a></div>
                    <div style="float:left; margin:2px; border:1px solid #8ea4c1; height:18px; width:16px; text-align:center; background-color:#dfe8f6" title="Chú ý">
                    ...
                    {if $user_level eq 3 or $user_level eq 6 or $user_level eq 7}<a href='javascript: void(0);' onclick="show_list_options({$count},{$total_num_result})">
...
<script language="javascript">	
	...
	function uncheck_fns_Doc(field,val,id){
		$("#doc_content_main").load("?processDoc&mod=docs&checkUncheck="+val+"&setfield="+field+"&checkUncheckID="+id);
	}
	
	function sort_me_Doc(id,val){
		$("#doc_content_main").load("?processDoc&mod=docs&sort_me=1&doc_id="+id+"&val="+val);
	}
	...
	function search_me_Doc(){
		...
		$.post('?processDoc&mod=docs&search_me=1&arg='+arg,
			{
	...
	function export_doc(exptype){
		...
		if(exptype==3){
			...
			$.post('?expDocReport&mod=docs&exptype='+exptype+'&arg='+arg,
				{
					tungay:tungay,
					denngay:denngay,
					soden_tu:soden_tu,
			...
			$('#doc_content_main').fadeOut('fast').load('index.php?processDoc&mod=docs').fadeIn("fast");
	...
	function edit_me_Doc(id){
		$("#doc_content_main").load("?processDoc&mod=docs&edit_me=1&doc_id="+id);
	}
