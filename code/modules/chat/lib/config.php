...
'en'
	/*'ar','bg','ca','cy','cz','da','de','el','en','es','et','fa','fi','fr','gl','he','hr','hu','in','it','ja','ka','kr','mk','nl','no','pl','pt-br','pt-pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh','zh-tw'*/
);
// Default language:
...
// Available styles:
$config['styleAvailable'] = array('beige','black','grey','Oxygen','Lithium','Sulfur','Cobalt','Mercury','Uranium','Plum','prosilver','subblack2','subSilver','Core');
// Default style:
