...
--------------------------------------------*/
 ...
 $processurl = "?listHuongdan&mod=daydocs";
 ...
 if($vars['edit_me']==1):
	 ...
	 if (!$obj->docday_id) redirect("?listHuongdan".$arg['arg']);
	 $obj_info = (array)$obj;
 endif;
 ...
 $display = dirname(__FILE__)."/skin/B_Huongdan_tbl.tpl";
 ...
 if (isset($vars['activeAjax']))
 	$smarty->display(dirname(__FILE__)."/skin/B_Huongdan_tbl.tpl");
 else
