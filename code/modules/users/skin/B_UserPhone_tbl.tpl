...
<div id="danhba_content_insign">
    ...
    <fieldset style="width:260px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:482px">
    <legend class="legend_list" style="width:120px">
        <div style="width:130px; float:left">Phòng/ban: {$total_depart}</div>
    </legend>
    	<div style="float:left; height:5px; width:100%"></div>
        <div style="float:left; height:455px; width:260px; overflow-y:scroll">
    ...
    <!------------------------------------DANH BA---------------------------------------------->
    <div style="float:left">
    <fieldset style="width:602px; border:1px solid #99bbe8; margin-left:3px; margin-top:5px; height:482px">
    <legend class="legend_list" style="width:150px">
    	...
    	<div style="float:left; height:25px; width:585px; border-top:1px solid #99bbe8; border-bottom:1px solid #99bbe8 ">
            ...
            <div class="tbl_tit" style="width:149px"><B>&nbsp;Họ tên</B></div>
            <div class="tbl_tit" style="width:139px"><B>&nbsp;Chức vụ</B></div>
            <div class="tbl_tit" style="width:85px"><B>&nbsp;Điện thoại</B></div>
            <div class="tbl_tit" style="width:177px"><B>&nbsp;Email</B></div>
        </div>
        <div style="float:left; height:428px; width:602px; overflow-y:scroll">
            ...
            <div class="{$class_td}" style="width:149px">
            ...
            <div class="{$class_td}" style="width:85px">
            	&nbsp;{$obj_list[ui]->user_phone}
            </div>
            <div class="{$class_td}" style="width:177px">
