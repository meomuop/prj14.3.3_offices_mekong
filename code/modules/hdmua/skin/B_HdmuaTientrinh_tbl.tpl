            ...
            <tr height="30">
            	<td align="center" width="24%" valign="top">
                    ...
                    <div style="float:left; width:84%; line-height:25px; text-align:left; height:50px">
                        <textarea spellcheck="false" name="tientrinh_ghichu" id="tientrinh_ghichu" cols="30" rows="5" class="text_area_small" onfocus="hide_message_Hdmua()" tabindex="8">{$obj_info.tientrinh_ghichu}</textarea>
                    </div>
                    ...
                    <script language="javascript">
                        ...
                        $(function() {
                            ...
                            $("#btnSub_HdmuaTientrinh").click(function() {
                                ...
                                //begin validate form
                                if (tientrinh_ghichu == "" || hdmua_id == "" || hdmua_sohd == "" ){
