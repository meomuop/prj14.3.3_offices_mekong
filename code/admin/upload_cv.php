...
class FileUploader {
 ...
 // script để thực hiện quá trình upload	
	function __construct($fileTypesAllowed = 'swf, jpg, jpeg, gif, png, doc, xls, docx, xlsx, pdf', $fileSizeMax = 15, $uploadDir = '../cv_uploads') {
	...
	*/
	function getLink($i) {
		...
		$return .= "<tr><td colspan=\"2\"><A href=\"Javascript: window.opener.document.frmList_CVFile.cv_file_path.value='$link_bs';window.close();window.history.go(1);\">Hoàn tất thao tác</A></td> </tr></table>";
		return $return;
	}
}
?>
