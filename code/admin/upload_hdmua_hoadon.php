 ...
 // script để thực hiện quá trình upload	
	...
	*/
	function getLink($i) {
		...
		$return .= "<tr><td colspan=\"2\"><A href=\"Javascript: window.opener.document.frmList_HdmuaHoadon.hoadon_file.value='$link_bs';window.close();window.history.go(1);\">Hoàn tất thao tác</A></td> </tr></table>";
		return $return;
	}
}
?>
