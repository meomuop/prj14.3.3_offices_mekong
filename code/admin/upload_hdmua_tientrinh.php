...
class FileUploader {
 ...
 // script để thực hiện quá trình upload	
	function __construct($fileTypesAllowed = 'jpg, jpeg, png, pdf', $fileSizeMax = 15, $uploadDir = '../hdmua_tientrinh_uploads') {
	...
	*/
	function getLink($i) {
		...
		$return .= "<tr><td colspan=\"2\"><A href=\"Javascript: window.opener.document.frmList_HdmuaTientrinh.tientrinh_file.value='$link_bs';window.close();window.history.go(1);\">Hoàn tất thao tác</A></td> </tr></table>";
		return $return;
	}
}
?>
