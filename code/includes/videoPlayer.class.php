<?php
 ...
 // } 
  ...
  class VideoPlayer {
     ...
     */
    public function __construct($swfObject,$swfUrl,$video, $width, $height, $autoplay = 'false', $controls = 'true') {
    ...
    private function returnPlayer() {
      ...
      /// Flash video player  
        ...
        $this->player .=
          '<div id="MyMovie">
            <a href="http://www.macromedia.com/go/getflashplayer">flash player</a> para visualizar este.
          </div>
          <script type="text/javascript">
            var s1 = new SWFObject("'.$this->swfUrl.'", "single","'.$this->width.'","'.$this->height.'","7","#ffffff");
