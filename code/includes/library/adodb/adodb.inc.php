 ...
 */
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/ 
	...
	{
		include(ADODB_DIR."/adodb-error.inc.php");
	...
	*/
	...
	{
		include(ADODB_DIR.'/adodb-perf.inc.php');
	...
	*/
	...
	if (PHP_VERSION < 5) include(ADODB_DIR.'/adodb-php4.inc.php');
	else include(ADODB_DIR.'/adodb-iterator.inc.php');
   /**
   ...
   */
	...
	*/
	...
	global $ADODB_LASTDB;
		...
		@include(ADODB_DIR."/drivers/adodb-".$db.".inc.php");
		$ADODB_LASTDB = $db;
	...
	function &NewPerfMonitor(&$conn)
	{
		...
		include(ADODB_DIR.'/adodb-perf.inc.php');
		@include(ADODB_DIR."/perf/perf-$drivername.inc.php");
	...
	function &NewDataDictionary(&$conn)
	{
		...
		include(ADODB_DIR.'/adodb-datadict.inc.php');
