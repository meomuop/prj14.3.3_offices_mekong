...
if (!defined(ADODB_DIR)) include(dirname(__FILE__).'/adodb.inc.php');
...
<table border=1 bgcolor=white><tr><td><b>Load</b><td><b>Count</b><td><b>SQL</b><td><b>Max</b><td><b>Min</b></tr>\n";
	...
	*/
	...
	{
	global $_GET,$HTTP_SERVER_VARS,$HTTP_POST_VARS;
	...
	*/
	...
	function DoSQLForm()
	{
	global $HTTP_SERVER_VARS,$_GET,$_POST,$HTTP_SESSION_VARS;
	
		$HTTP_VARS = array_merge($_GET,$HTTP_POST_VARS);
