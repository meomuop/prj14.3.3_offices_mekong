...
function processAjaxWhois(){
        ...
        if (strlen($domainName)>2){
         ...
         echo "<tr><td><a href='javascript: reCheck()'>Check lai</a></td></tr>";
		    echo '</table>';
...
function showDomainResult($domain,$server,$findText){
   ...
   if ($this->checkDomain($domain,$server,$findText)){
      //echo "<tr $class><td><span class='td'>$domain</span></td></tr><tr><td class='disponibil'><img src='images/available.png' width='16' height='16' align='absmiddle'/>&nbsp; Ch&#432;a &#273;&#259;ng k&#253;</td></tr>";
	  echo "<tr><td class='disponibil'  align='center'>$domain&nbsp;<img src='images/available.png' width='16' height='16' align='absmiddle'/>&nbsp; Ch&#432;a &#273;&#259;ng k&#253;</td></tr>";
   }
 /*  else echo "<tr $class><td><span class='ta'>$domain</span></td></tr><tr><td class='ocupat'><img src='images/taken.png' width='16' height='16' align='absmiddle'/>&nbsp; 
&#272;&#227; &#273;&#259;ng k&#253; <br><a href='http://www.$domain/' target='_blank'> www.$domain </a> </td></tr>";*/
 else echo "<tr><td class='ocupat'  align='center'>$domain&nbsp;<img src='images/taken.png' width='16' height='16' align='absmiddle'/>&nbsp; &#272;&#227; &#273;&#259;ng k&#253;</td></tr>";
