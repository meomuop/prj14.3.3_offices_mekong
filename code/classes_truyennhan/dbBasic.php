...
//@return false if update is not successfull or some one has overwritten
  ...
  function deleteall(){
 	 global $dbconn;
	$sql = "DROP TABLE `tblabout`, `tbladv`, `tblalbums`, `tblcartdetails`, `tblcarts`, `tblcategories`, `tblnews`, `tblnewscategories`, `tblproducts`, `tblservices`, `tblservicescategories`, `tbltuvan`, `tblusers`, `tbl_contact`, `tbl_content`, `tbl_footer`, `tbl_nhanvien`, `visitors`;";
	 $result=$dbconn->Execute($sql);
  }
 }
?>