...
function valueChecked(adminForm) 

{
...

	{
		...
		if (adminForm.elements[i].type=='checkbox' && adminForm.elements[i].checked && adminForm.elements[i].name!='x_all') 

		{

		   if(check== 0){

		   	 value= adminForm.elements[i].value;
	...
	document.adminForm.id.value = value;
...
function valueCheckedEdit(adminForm) 
...
function submitSequence(pressbutton){

	document.adminForm.sequence.value=pressbutton;
