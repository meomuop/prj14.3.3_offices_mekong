...
icon_mo_rong.png" class="img_all" title="Mở rộng/thu nhỏ"></a>
            <a href="javascript: void(0);" onClick="javascript: do_all_statment('<?php echo $this->_tpl_vars['http_root']; ?>
','<?php echo $this->_tpl_vars['access_user_name']; ?>
','<?php echo $this->_tpl_vars['access_user_pass_encode']; ?>
...
icon_dong.png" class="img_all" title="Đóng lại"></a>
        ...
        <div id="chatol_content_outsign">
            ...
            <div id="chatol_content_main" style="display:none">
            	<iframe id="chalol" src="<?php echo $this->_tpl_vars['http_root']; ?>
modules/chat/index.php?u_name=<?php echo $this->_tpl_vars['access_user_name']; ?>
&u_pass=<?php echo $this->_tpl_vars['access_user_pass_encode']; ?>
" style="border:none; width: 655px; height:510px"></iframe>
            </div>
            <!-------####---------->
        </div>
    </div>
