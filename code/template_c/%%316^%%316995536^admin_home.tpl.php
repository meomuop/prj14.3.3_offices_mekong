...
$this->_smarty_include(array('smarty_include_tpl_file' => "div_config.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_thuoctinh.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_user.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_vttb.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_plan.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_doc.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_doc_report.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_transport.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_congviec.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_msg.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_chatol.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_kdl.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_danhba.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "div_alert_all.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <!--****************************************HETVUNG DIV CHUC NANG****************************************-->
    <div id="wrap" style="margin-top:0px">
    	<div id="banner"><img src="<?php echo $this->_tpl_vars['css_img_bg']; ?>
banner.jpg" width="1200" /></div>
        <div id="main" style="line-height: 1.2em;">
        	<div id="l-main">
            	<img src="<?php echo $this->_tpl_vars['css_img_bg']; ?>
b1.jpg" height="520" />
            </div>
            <!--***************************************KHUNG CHUC NANG**************************************-->
            <div id="c-main">
            	<input type="hidden" value="<?php echo $this->_tpl_vars['http_root']; ?>
" name="http_root" id="http_root">
            	<!----------------------------------QUAN TRI CAO CAP------------------------------------------->
                	...
                	<div class="c11">
                        ...
                        <div class="c12">
                            <ul>
                                <li class="outside">
                                	<ul class="inside">
                                    	<li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
config_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
config_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
config_btn_focus.png)'" value="" name="config" id="config" onClick="javascript: document.getElementById('div_config').style.display='block'" <?php if ($this->_tpl_vars['user_level'] != 1): ?> disabled<?php endif; ?>></li>
                                ...
                                <li class="outside">
                                    <ul class="inside">
                                        <li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
doc_config_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
doc_config_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
doc_config_btn_focus.png)'" value="" name="thuoctinh" id="thuoctinh" onClick="javascript: document.getElementById('div_thuoctinh').style.display='block'" <?php if ($this->_tpl_vars['user_level'] != 1): ?> disabled<?php endif; ?>></li>
                                ...
                                <li class="outside">
                                    <ul class="inside">
                                        <li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
user_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
user_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
user_btn_focus.png)'" value="" name="user" id="user" onClick="javascript: document.getElementById('div_user').style.display=''" <?php if ($this->_tpl_vars['user_level'] != 1): ?> disabled<?php endif; ?>></li>
                                ...
                                <li class="outside">
                                    <ul class="inside">
                                        <li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
sms_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
sms_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
sms_btn_focus.png)'" value="" name="iconmsg" id="iconmsg" onClick="javascript: document.getElementById('div_msg').style.display=''"></li>
                ...
                <!--------------------------------DANH MUC CHUC NANG----------------------------------------->
                <input type="hidden" name="user_level_txt" id="user_level_txt" value="<?php echo $this->_tpl_vars['user_level']; ?>
">
                <input type="hidden" name="user_level_tnvb" id="user_level_tnvb" value="<?php echo $this->_tpl_vars['user_level_tnvb']; ?>
">
                        ...
                        <div class="c12">
                            <ul>
                                ...
                                <li class="outside">
                                	<ul class="inside">
                                    	<li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
doc_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
doc_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
doc_btn_focus.png)'" value="" name="icondoc" id="icondoc" onClick="javascript: document.getElementById('div_doc').style.display=''"></li>
                                ...
                                <li class="outside">
                                	<ul class="inside">
                                    	<li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
contract_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
contract_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
contract_btn_focus.png)'" value="" name="iconcontract" id="iconcontract" onClick="javascript: document.getElementById('div_transport').style.display=''"></li>
                                ...
                                <li class="outside">
                                	<ul class="inside">
                                    	<li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
task_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
task_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
task_btn_focus.png)'" value="" name="iconcv" id="iconcv" onClick="javascript: document.getElementById('div_cv_cat').style.display=''"></li>
                                ...
                                <li class="outside">
                                    <ul class="inside">
                                        <li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
salary_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
salary_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
salary_btn_focus.png)'" value="" name="iconcv" id="iconcv" onClick="javascript: document.getElementById('div_cv_cat').style.display=''"></li>
                                ...
                                <li class="outside">
                                    <ul class="inside">
                                        <li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
storage_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
storage_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
storage_btn_focus.png)'" value="" name="iconvttb" id="iconvttb" onClick="javascript: document.getElementById('div_vttb').style.display=''"></li>
                                ...
                                <li class="outside">
                                    <ul class="inside">
                                        <li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
schedule_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
schedule_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
schedule_btn_focus.png)'" value="" name="iconplan" id="iconplan" onClick="javascript: document.getElementById('div_plan').style.display=''"></li>
                                ...
                                <li class="outside">
                                    <ul class="inside">
                                        <li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
phone_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
phone_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
phone_btn_focus.png)'" value="" name="icondanhba" id="icondanhba" onClick="javascript: document.getElementById('div_danhba').style.display=''"></li>
                                ...
                                <li class="outside">
                                	<ul class="inside">
                                    	<li><input type="button" class="main_item_icon" style="background: url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
file_btn_blur.png) repeat scroll 0% 0% transparent;" onmouseout="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
file_btn_blur.png)'" onmouseover="this.style.background='url(<?php echo $this->_tpl_vars['css_btn_bg']; ?>
file_btn_focus.png)'" value="" name="iconkdl" id="iconkdl" onClick="javascript: document.getElementById('div_kdl').style.display=''"></li>
                ...
                <div class="c2">
                    <div class="c21">
                        ...
                        <div class="c22" style="height:218px; line-height:20px; width:254px; overflow-y:scroll">
                            <?php if (isset($this->_sections['hi'])) unset($this->_sections['hi']);
$this->_sections['hi']['name'] = 'hi';
$this->_sections['hi']['loop'] = is_array($_loop=$this->_tpl_vars['hdsd_list']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                            	&nbsp;&bull; <a href="javascript:void(0)" onClick="javascript:show_video(<?php echo $this->_tpl_vars['hdsd_list'][$this->_sections['hi']['index']]->hdsd_id; ?>
)"><?php echo $this->_tpl_vars['hdsd_list'][$this->_sections['hi']['index']]->hdsd_name; ?>
</a><br>
                            <?php endfor; endif; ?>
                        </div>
                        <?php echo '
...
" width="90" height="120" align="absmiddle">
                                <?php else: ?>
                            ...
                            <div style="float:left; width:153px; height:130px; margin-left:4px; font-size:12px">
                                <div style="float: left">- Họ tên:&nbsp;<b><?php echo $this->_tpl_vars['access_user_fullname']; ?>
</b><br><br>
                                - Tài khoản:&nbsp;<b><?php echo $this->_tpl_vars['access_user_name']; ?>
</b><br><br>
                                - C/V:&nbsp;<b><?php echo $this->_tpl_vars['access_object_name']; ?>
</b><br><br>
                                - P/B:&nbsp;<b><?php echo $this->_tpl_vars['access_department_name']; ?>
</b><br><br></div>
                            ...
                            <a href="javascript: void(0)" onClick="javascript:show_user_edit(<?php echo $this->_tpl_vars['access_user_id']; ?>
)">Sửa thông tin tài khoản cá nhân</a>
                            </span><br>
                            <span style=" line-height:22px">
            ...
            <div style="float:left; width:100%; line-height:25px; font-size: 11px; margin-top: 3px">
                <br>
                <a href="http://mekonggroup.net/" target="_blank" style="text-decoration:none; color:#666; font-size: 11px">&copy; 2018 - <?php echo date('Y'); ?> Tập đoàn MEKONG.</a>&nbsp;|&nbsp;
                ...
                &nbsp;|&nbsp;<?php echo "Today: ".date('d')."-".date('m')."-".date('Y'); ?>
            </div>
            <!--*******************************************HET KHUNG FOOTER***********************************-->
        </div>
    </div>
