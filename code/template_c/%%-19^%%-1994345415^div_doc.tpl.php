<?php /* Smarty version 2.6.2, created on 2018-12-16 10:28:52
         compiled from div_doc.tpl */ ?>
﻿<?php echo '
<style>
...
icon_dong.png" class="img_all" title="Đóng lại"></a>
        ...
        <div id="doc_menu">
            ...
            <?php elseif ($this->_tpl_vars['user_level'] == 3): ?>
                <a href="javascript: void(0)" onclick="change_style_doc(1)" id="a_menu_doc_1">
            ...
            <?php elseif ($this->_tpl_vars['user_level'] == 4 || $this->_tpl_vars['user_level'] == 5 || $this->_tpl_vars['user_level'] == 6 || $this->_tpl_vars['user_level'] == 7 || $this->_tpl_vars['user_level'] == 8 || $this->_tpl_vars['user_level'] == 10): ?>
            	<a href="javascript: void(0)" onclick="change_style_doc(1)" id="a_menu_doc_1">
                    <div class="c_menu_doc" id="c_menu_doc_1" style="width:80px; border-left:1px solid #99bbe8; border-bottom:1px solid #dfe8f6; background-color:#dfe8f6; height:25px; margin-top:0px">Văn bản đến</div></a>
                <a href="javascript: void(0)" onclick="change_style_doc(2)" id="a_menu_doc_2">
...
<div id="list_file" onclick="javascript: change_bgcl_doc('list_file')" style="width:280px; float:left; font-weight:normal; position:absolute; display:none; margin:90px 0 0 690px; background-color:#ffffff; border:1px solid #99bbe8; z-index:1010; padding: 0px 1px 1px 1px">
