<?php /* Smarty version 2.6.2, created on 2018-12-16 09:48:59
         compiled from div_plan.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'div_plan.tpl', 167, false),)), $this); ?>
﻿<?php echo '
<style>
            ...
            <div id="div_more_lich" style="position:absolute; margin:7px 130px; width:540px; display:none">
                ...
                <div style="float:left; width:48px; line-height:20px; height:20px; text-align:left">
                    <div style="float:left; width:38px; height:18px; border:1px solid #99bbe8; background-color:#FFF; margin-bottom:2px">
                            <input type="text" id="tu_ngay_1" name="tu_ngay_1" class="text_date" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['tu_ngay'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%d') : smarty_modifier_date_format($_tmp, '%d')); ?>
" onkeypress="set_focus('tu_ngay_1','tu_ngay_2')" maxlength="2" tabindex="1"/>/
                            <input type="text" id="tu_ngay_2" name="tu_ngay_2" class="text_month" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['tu_ngay'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%m') : smarty_modifier_date_format($_tmp, '%m')); ?>
" maxlength="2" tabindex="2"/>
                ...
                <div style="float:left; width:48px; line-height:20px; height:20px; text-align:left">
                    <div style="float:left; width:38px; height:18px; border:1px solid #99bbe8; background-color:#FFF; margin-bottom:2px">
                            <input type="text" id="den_ngay_1" name="den_ngay_1" class="text_date" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['den_ngay'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%d') : smarty_modifier_date_format($_tmp, '%d')); ?>
" onkeypress="set_focus('den_ngay_1','den_ngay_2')" maxlength="2" tabindex="3"/>/
                            <input type="text" id="den_ngay_2" name="den_ngay_2" class="text_month" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['den_ngay'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%m') : smarty_modifier_date_format($_tmp, '%m')); ?>
                ...
                <div style="float:left; width:27px; line-height:20px; height:20px; text-align:left">Năm:</div>
                    <div style="float:left; width:35px; line-height:20px; height:20px; text-align:left">
                        <div style="float:left; width:30px; height:18px; border:1px solid #99bbe8; background-color:#FFF; margin-bottom:2px">
                              <input type="text" id="lich_nam" name="lich_nam" class="text_year" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['lich_nam'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y') : smarty_modifier_date_format($_tmp, '%Y')); ?>
