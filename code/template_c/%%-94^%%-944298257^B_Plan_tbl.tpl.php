<?php /* Smarty version 2.6.2, created on 2018-12-16 10:29:46
         compiled from E:%5CProjects%5Cwamp64%5Cwww%5Csmarty%5Cprj14.3.3_offices_mekong%5Ccode%5Cmodules%5Cplans/skin/B_Plan_tbl.tpl */ ?>
<?php echo '
<style type="text/css">
...
<div id="plan_content_insign">
	<form method="post" name="frmList_Plan" action="?listPlan<?php echo $this->_tpl_vars['vars']['arg']; ?>
" id="frmList_Plan">
    <!------------------------------------NOI DUNG KE HOACH---------------------------------------------->
    <div style="float:left">
        ...
        <div style="float:left; height:502px; width:635px; border:1px solid #99bbe8; margin-left:2px">
        	<iframe id="calendar" src="<?php echo $this->_tpl_vars['http_root']; ?>
/calendar/json.php?bld=<?php echo $this->_tpl_vars['bld']; ?>
&user_ld=<?php echo $this->_tpl_vars['user_ld']; ?>
" class="alliframe" width="635px" height="502px" scrolling="no"></iframe>
        </div>
    </div>
    </form>
</div>
